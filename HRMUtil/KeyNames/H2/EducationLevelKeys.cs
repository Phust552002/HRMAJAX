...
namespace HRMUtil.KeyNames.H2
{
    public sealed class EducationLevelKeys
    {
        ...
        public const string Sp_Sel_EducationLevel_All_By_Filter = "Sel_H2_EducationLevel_All_By_Filter";
        public const string Sp_Sel_H2_EducationLevel_By_ForeignLanguage_Computer_DrivingLicense = "Sel_H2_EducationLevel_By_ForeignLanguage_Computer_DrivingLicense";

...
namespace HRMUtil.KeyNames.H
{
    public sealed class EmployeeIncomeKeys
    {
        ...
        public const string Field_Employee_Income_Total_Real = "Total_Real";
        ...
        public const string SP_Sel_H_EmployeeIncomeForStatisticTotalByFilter = "Sel_H_EmployeeIncomeForStatisticTotalByFilter";

        public const string Sp_Ins_EmployeeIncome = "Ins_EmployeeIncome";
    }
}

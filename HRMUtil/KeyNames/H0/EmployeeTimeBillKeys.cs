...
namespace HRMUtil.KeyNames.H0
{
    public sealed class EmployeeTimeBillKeys
    {
        ...
        public const string Sp_Sel_H0_EmployeeTimeBillForDistinctWorkdateByUserId = "Sel_H0_EmployeeTimeBillForDistinctWorkdateByUserId";
        ...
        public const string Sp_Sel_H0_EmployeeTimeBillByUserDateForWorkingAndHo = "Sel_H0_EmployeeTimeBillByUserDateForWorkingAndHo";
        public const string Sp_Sel_H0_EmployeeTimeBillForDistinctWorkdateByUserIdFromToWorkDate = "Sel_H0_EmployeeTimeBillForDistinctWorkdateByUserIdFromToWorkDate";
        public const string Sp_Sel_H0_EmployeeTimeBillByRootDate = "Sel_H0_EmployeeTimeBillByRootDate";
        public const string Sp_Sel_H0_EmployeeTimeBillByDeptDate = "Sel_H0_EmployeeTimeBillByDeptDate";
        public const string Sp_Sel_DateTimeNow = "Sel_DateTimeNow";

        public const string Sp_Sel_H0_EmployeeTimeBill_Log_ByUserId_WorkDate = "Sel_H0_EmployeeTimeBill_Log_ByUserId_WorkDate";
        public const string Sp_Sel_H0_EmployeeTimeBillForDistinctWorkdateByUserIdFromToWorkDateWithX = "Sel_H0_EmployeeTimeBillForDistinctWorkdateByUserIdFromToWorkDateWithX";

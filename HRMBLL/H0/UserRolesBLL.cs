...
namespace HRMBLL.H0
{
    public class UserRolesBLL
    {
        ...
        public static List<UserRolesBLL> GetRoleByDepartment(int departmentId)
        {
            return GenerateUserRolesBLLFromDataTable(new RoleUsersDAL().GetRoleByDepartment(departmentId));
        }
        ...
        public static bool IsHRUserNameChecker(int userId)
        {
            List<UserRolesBLL> list = GenerateUserRolesBLLFromDataTable(new RoleUsersDAL().GetByUserId_RoleId(userId, Constants.Role_UserNameChecker));
        ...
        public static bool IsPMemberAdmin(int userId)
        {
            List<UserRolesBLL> list = GenerateUserRolesBLLFromDataTable(new RoleUsersDAL().GetByUserId_RoleId(userId, Constants.Role_PMember_Admin));

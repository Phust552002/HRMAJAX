...
namespace HRMBLL.H0
{
    public class EmployeeTimeBillBLL
    {
       ...
       public int UserTimeBillId    
        ...
        public static DataTable GetLogByUserIdAndDate(int userId, DateTime selectedDate)
        {
            return new EmployeeTimeBillDAL().GetLogByUserIdAndDate(userId, selectedDate);
        }
        ...
        public static List<EmployeeTimeBillBLL> GetByDateDepartmentId(string fullName, int deptId, DateTime inputDate)
        {
            return GenerateListEmployeeTimeBillBLLFromDataTable(new EmployeeTimeBillDAL().GetByDateDepartmentId(fullName, deptId, inputDate));

...
namespace HRMBLL.H0
{
    public class SecurityControlBLL
    {
        ...
        public static DataTable GetAllByFilter(string fullName, string departmentIds, string status, DateTime almostExpired, int isLost)
        {
            return new SecurityControlDAL().GetAllByFilter(fullName, departmentIds, status, almostExpired, isLost);
        }
        ...
        public static long Insert_SCIManagement(int LostId, int SecurityControlId, int UserId, DateTime LostDate, int LostTime, string Remark)
        {
            return new SecurityControlDAL().Insert_SCIManagement(LostId, SecurityControlId, UserId, LostDate, LostTime, Remark);
        }

...
namespace HRMBLL.H1
{
    public class WorkdayEmployeesBLLL
    {
        ...
        public static long InsertByDate_DeptId(string deptIds, DateTime workdayDateL, int createUserL, bool isDirect, int statusL)
        {
            ...
            double XQDL = 0;// DefaultValues.XQDSalary(workdayDateL.Month, workdayDateL.Year);
            int typeL = 1;
            if (isDirect)
            {
                typeL = 0;
        ...
        public static long InsertByDate_UserId(int userId, DateTime workdayDateL, int createUserL, bool isDirect, int statusL)
        {
            ...
            double XQDL = DefaultValues.XQD(workdayDateL.Month, workdayDateL.Year, isDirect);
            int typeL = 1;
            if (isDirect)
            {
                typeL = 0;
            ...
            )
        {
            ...
            double XQDL = 0;// DefaultValues.XQDSalary(workdayDate.Month, workdayDate.Year);

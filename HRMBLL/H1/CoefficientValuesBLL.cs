...
namespace HRMBLL.H1
{
    public class CoefficientValuesBLL
    {
        ...
        public CoefficientValuesBLL(int coefficientValueId, int coefficientNameId, int coefficientLevelId, double coefficientValue)
        {
            _CoefficientValueId = coefficientValueId;
            _CoefficientNameId = coefficientNameId;
            _CoefficientLevelId = coefficientLevelId;
            _CoefficientValue = coefficientValue;
        ...
        public static long Insert(string coefficientName,
            double value_Level_1, double conditions1, double value_Level_2, double conditions2, double value_Level_3, double conditions3,
            double value_Level_4, double conditions4, double value_Level_5, double conditions5, double value_Level_6, double conditions6,
            double value_Level_7, double conditions7, double value_Level_8, double conditions8, double value_Level_9, double conditions9,
            double value_Level_10, double conditions10, double value_Level_11, double conditions11, double value_Level_12, double conditions12,
        ...
        public static CoefficientValuesBLL GetByName_Level(int coefficientNameId, int coefficientLevelId)
        {
            ...
            DataTable dt = objDAL.GetByName_Level(coefficientNameId, coefficientLevelId);
        ...
        {
            List<CoefficientValuesBLL> list = new List<CoefficientValuesBLL>();
        ...
        {
            CoefficientValuesBLL objBLL = new CoefficientValuesBLL(
                ...
                dr[CoefficientValueKeys.FIELD_COEFFICIENT_VALUE] == DBNull.Value ? 0 : double.Parse(dr[CoefficientValueKeys.FIELD_COEFFICIENT_VALUE].ToString()));

            objBLL.Conditions = dr[CoefficientValueKeys.FIELD_COEFFICIENT_CONDITIONS] == DBNull.Value ? 0 : double.Parse(dr[CoefficientValueKeys.FIELD_COEFFICIENT_CONDITIONS].ToString());
            ...
            objBLL.Description = dr[CoefficientNameKeys.Field_CoefficientNames_CoefficientNameDescription] == DBNull.Value ? string.Empty : dr[CoefficientNameKeys.Field_CoefficientNames_CoefficientNameDescription].ToString();
            objBLL.SalaryRegulationId = dr[CoefficientNameKeys.Field_CoefficientNames_SalaryRegulationId] == DBNull.Value ? 0 : int.Parse(dr[CoefficientNameKeys.Field_CoefficientNames_SalaryRegulationId].ToString());
            objBLL.Type = dr[CoefficientNameKeys.Field_CoefficientNames_Type] == DBNull.Value ? 0 : int.Parse(dr[CoefficientNameKeys.Field_CoefficientNames_Type].ToString());
            return objBLL;
        }

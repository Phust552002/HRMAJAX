...
namespace HRMBLL.H1.Helper
{
    public static class DefaultValues
    {
        ...
        //{
        //    DateTime dt;            
        //    int daysInNow = DateTime.DaysInMonth(year, month);
        //    int count = 0;
        //    int i = 1;
        //    while (i <= daysInNow)
        //    {
        ...
        //    List<HolidaysBLL> listHoliday = HolidaysBLL.GetByDate(month, year);
        ...
        public static double XQD(int month, int year, bool isDirect)
        {
            bool isOfficeHours = isDirect;
            DateTime dt;
            int daysInNow = DateTime.DaysInMonth(year, month);
            int count = 0;
            int i = 1;
        ...
        public static double XDuocCham(int month, int year, bool isDirect)
        {
            DateTime dt;
            int daysInNow = DateTime.DaysInMonth(year, month);
            int count = 0;
        ...
        public static double CalculateLeaveDay(string Day1, string Day2, string Day3, string Day4, string Day5, string Day6,
                    ...
                    string Day28, string Day29, string Day30, string Day31, int leaveType)
        {
            ...
            string nuagioSymbol = "1/2" + leaveTypeCode;
        ...
        public static double CalculateNights(double night1, double night2, double night3, double night4, double night5, double night6, double night7, double night8, double night9, double night10,
                    double night11, double night12, double night13, double night14, double night15, double night16, double night17, double night18, double night19, double night20,
                    double night21, double night22, double night23, double night24, double night25, double night26, double night27, double night28, double night29, double night30, double night31)
        {
            double countNight = 0;
        ...
        public static double CountDayByContract(WorkdayEmployeesBLLL objWE, EmployeeContractBLL objEC, string leaveTypeCode)
        {
            double countLeaveDays = 0;
            string nuagioSymbol = "1/2" + leaveTypeCode;

            List<DateTime> listLeave = new List<DateTime>();
            
            DateTime fromDate = objEC.FromDate;
            DateTime toDate = objEC.ToDate;
            int daysInMonths = DateTime.DaysInMonth(objWE.WorkdayDateL.Year, objWE.WorkdayDateL.Month);
        ...
        public static double CountDayByFromToDate(WorkdayEmployeesBLLL objWE, DateTime fromDateInput, DateTime toDateInput, string leaveTypeCode)
        {
            double countLeaveDays = 0;
            string nuagioSymbol = "1/2" + leaveTypeCode;
            ...
            DateTime fromDate = fromDateInput;
            DateTime toDate = toDateInput;
            int daysInMonths = DateTime.DaysInMonth(objWE.WorkdayDateL.Year, objWE.WorkdayDateL.Month);
        ...
        public static double CalculateLeaveDay(int month, int year, int userid, string Day1, string Day2, string Day3, string Day4, string Day5, string Day6,
                   string Day7, string Day8, string Day9, string Day10, string Day11, string Day12, string Day13,
                   string Day14, string Day15, string Day16, string Day17, string Day18, string Day19, string Day20,
                   string Day21, string Day22, string Day23, string Day24, string Day25, string Day26, string Day27,
                   string Day28, string Day29, string Day30, string Day31, int leaveType)
        ...
        public static double CalculateLeaveDay(int month, int year, int userid, string Day1, string Day2, string Day3, string Day4, string Day5, string Day6,
                   ...
                   string Day14, string Day15, string Day16, string Day17, string Day18, string Day19, string Day20,
                   string Day21, string Day22, string Day23, string Day24, string Day25, string Day26, string Day27,
                   string Day28, string Day29, string Day30, string Day31, int leaveType, bool isUpdateEmployeeLeave, ref double resultCalculateLeave)
        {
            ...
            if (countLeaveDays > 0)
            {
                DateTime fromdate = FormatDate.GetSQLDateMinValue, todate = FormatDate.GetSQLDateMinValue, dateTemp = FormatDate.GetSQLDateMinValue;
                int i = 0;
                ...
                while (i < listLeave.Count)
                {
                    ...
                    else
                    {
                        ...
                        for (int j = i; j < listLeave.Count - 1; j++)
                        {
        ...
        public static bool IsWorking(string symbol)
        {
            ...
            if (symbol.Equals(Constants.LEAVE_TYPE_LE_TET_CODE) || symbol.Equals(Constants.LEAVE_TYPE_X_CODE)
                || symbol.Contains(Constants.LEAVE_TYPE_1_2_X_CODE) || symbol.Contains(Constants.LEAVE_TYPE_NGHI_BU_CODE))
            {
                return true;
        ...
        public static string ConvertWorking(string symbol, string ContractTypeCode = "")
        {
            string nuaX_nuaNT = Constants.LEAVE_TYPE_1_2_X_CODE + "+1/2" + Constants.LEAVE_TYPE_NGHI_TUAN_CODE;
            string nuaX_nuaNB = Constants.LEAVE_TYPE_1_2_X_CODE + "+1/2" + Constants.LEAVE_TYPE_NGHI_BU_CODE;

            string nuaNT_nuaX = "1/2" + Constants.LEAVE_TYPE_NGHI_TUAN_CODE + "+" + Constants.LEAVE_TYPE_1_2_X_CODE;
            string nuaNB_nuaX = "1/2" + Constants.LEAVE_TYPE_NGHI_BU_CODE + "+" + Constants.LEAVE_TYPE_1_2_X_CODE;

            string nuaX = Constants.LEAVE_TYPE_1_2_X_CODE;

            if (symbol.Equals(Constants.LEAVE_TYPE_X_CODE))
            //Rem 20200819 requested by Ms. Thuy
            ...
            //Rem 20200709 requested by Ms. Thuy
            ...
            //if (symbol.Contains(Constants.LEAVE_TYPE_HOC_SAGS_CODE))
            //{
            //    return symbol.Replace(Constants.LEAVE_TYPE_HOC_SAGS_CODE, Constants.LEAVE_TYPE_X_CODE) == "1/2X+1/2X" ? Constants.LEAVE_TYPE_X_CODE : symbol.Replace(Constants.LEAVE_TYPE_HOC_SAGS_CODE, Constants.LEAVE_TYPE_X_CODE);
            //}
            //Rem 20200819 requested by Ms. Thuy
            //if (symbol.Equals(nuaX_nuaNT) || symbol.Equals(nuaNT_nuaX))
            //{
            //    return Constants.LEAVE_TYPE_1_2_X_CODE;
            //}
            //if (symbol.Trim().Equals(nuaX))
            //{
            //    if (ContractTypeCode.Equals("HDVK") || ContractTypeCode.Equals("HDVK3T") || ContractTypeCode.Equals("HDVK12T"))
            //    {
            //        return symbol;
            //    }
            //    else
        ...
        public static bool CheckIsPositiveMark(int HTCVCatalogueId)
        {
            ...
            if(HTCVCatalogueId == Constants.HTCVCatalogueType_Mediate_Id)
            {
                return true;
            }
            else
        ...
        {
            string[] arr = minMark_maxMark.Split(';');
            double minMark = Math.Abs(double.Parse(arr[0]));
            double maxMark = Math.Abs(double.Parse(arr[1]));
            mark = Math.Abs(mark);
        ...
        public static List<HTCVEmployeeBLL> SortHTCVEmployeeBLL(List<HTCVEmployeeBLL> list)
        {
            ...
            List<HTCVEmployeeBLL> listReturn = new List<HTCVEmployeeBLL>();
            List<HTCVEmployeeBLL> listTemp = new List<HTCVEmployeeBLL>();            
            if (list.Count > 0)
            {
                HTCVCatalogueBLL objHC0 = HTCVCatalogueBLL.GetById(list[0].ParentId);
                HTCVEmployeeBLL objHE0 = new HTCVEmployeeBLL();
                ...
                else
                {
                    ...
                    for (int i = 1; i < list.Count; i++)
                    {
                        ...
                        else
                        {
                            ...
                            foreach (HTCVEmployeeBLL objSorted in listTemp)
                                listReturn.Add(objSorted);
                            listTemp.Clear();
                            HTCVCatalogueBLL objHC0I = HTCVCatalogueBLL.GetById(list[i].ParentId);
                            HTCVEmployeeBLL objHE0I = new HTCVEmployeeBLL();
        ...
        public static bool IsMediateDepartment(int departmentId)
        {
            ...
            string mediateDeptIds = ",1,2,8,9,61,16,14,62,4,17,63,28,64,29,60,58,59,70,71,72,";

            return Util.IsContains(mediateDeptIds, departmentId);
        }
        public static bool IsNotCalculateNightTimeDepartment(int departmentId)
        {
            string mediateDeptIds = ",1,2,8,9,61,10,11,3,12,14,4,58,59,";

            return Util.IsContains(mediateDeptIds, departmentId);
        }

        public static double CalculateLeaveDayL(int month, int year, int userid, string Day1, string Day2, string Day3, string Day4, string Day5, string Day6,
                  string Day7, string Day8, string Day9, string Day10, string Day11, string Day12, string Day13,
                  string Day14, string Day15, string Day16, string Day17, string Day18, string Day19, string Day20,
                  string Day21, string Day22, string Day23, string Day24, string Day25, string Day26, string Day27,
                  string Day28, string Day29, string Day30, string Day31, int leaveType)
        {
            ...
            if (Day1 != null && Day1 != "")
            {
                ...
                //if (Day1.Equals(leaveTypeCode) || Day1.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day1.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day2 != null && Day2 != "")
            {
                ...
                //if (Day2.Equals(leaveTypeCode) || Day2.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day2.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day3 != null && Day3 != "")
            {
                ...
                //if (Day3.Equals(leaveTypeCode) || Day3.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day3.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day4 != null && Day4 != "")
            {
                ...
                //if (Day4.Equals(leaveTypeCode) || Day4.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day4.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day5 != null && Day5 != "")
            {
                ...
                //if (Day5.Equals(leaveTypeCode) || Day5.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day5.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day6 != null && Day6 != "")
            {
                ...
                //if (Day6.Equals(leaveTypeCode) || Day6.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day6.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day7 != null && Day7 != "")
            {
                ...
                //if (Day7.Equals(leaveTypeCode) || Day7.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day7.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day8 != null && Day8 != "")
            {
                ...
                //if (Day8.Equals(leaveTypeCode) || Day8.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day8.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day9 != null && Day9 != "")
            {
                ...
                //if (Day9.Equals(leaveTypeCode) || Day9.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day9.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day10 != null && Day10 != "")
            {
                ...
                //if (Day10.Equals(leaveTypeCode) || Day10.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day10.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day11 != null && Day11 != "")
            {
                ...
                //if (Day11.Equals(leaveTypeCode) || Day11.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day11.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day12 != null && Day12 != "")
            {
                ...
                //if (Day12.Equals(leaveTypeCode) || Day12.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day12.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day13 != null && Day13 != "")
            {
                ...
                //if (Day13.Equals(leaveTypeCode) || Day13.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day13.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day14 != null && Day14 != "")
            {
                ...
                //if (Day14.Equals(leaveTypeCode) || Day14.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day14.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day15 != null && Day15 != "")
            {
                ...
                //if (Day15.Equals(leaveTypeCode) || Day15.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day15.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day16 != null && Day16 != "")
            {
                ...
                //if (Day16.Equals(leaveTypeCode) || Day16.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day16.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day17 != null && Day17 != "")
            {
                ...
                //if (Day17.Equals(leaveTypeCode) || Day17.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day17.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day18 != null && Day18 != "")
            {
                ...
                //if (Day18.Equals(leaveTypeCode) || Day18.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day18.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day19 != null && Day19 != "")
            {
                ...
                //if (Day19.Equals(leaveTypeCode) || Day19.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day19.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day20 != null && Day20 != "")
            {
                ...
                //if (Day20.Equals(leaveTypeCode) || Day20.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day20.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day21 != null && Day21 != "")
            {
                ...
                //if (Day21.Equals(leaveTypeCode) || Day21.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day21.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day22 != null && Day22 != "")
            {
                ...
                //if (Day22.Equals(leaveTypeCode) || Day22.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day22.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day23 != null && Day23 != "")
            {
                ...
                //if (Day23.Equals(leaveTypeCode) || Day23.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day23.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day24 != null && Day24 != "")
            {
                ...
                //if (Day24.Equals(leaveTypeCode) || Day24.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day24.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day25 != null && Day25 != "")
            {
                ...
                //if (Day25.Equals(leaveTypeCode) || Day25.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day25.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day26 != null && Day26 != "")
            {
                ...
                //if (Day26.Equals(leaveTypeCode) || Day26.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day26.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day27 != null && Day27 != "")
            {
                ...
                //if (Day27.Equals(leaveTypeCode) || Day27.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day27.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day28 != null && Day28 != "")
            {
                ...
                //if (Day28.Equals(leaveTypeCode) || Day28.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day28.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day29 != null && Day29 != "")
            {
                ...
                //if (Day29.Equals(leaveTypeCode) || Day29.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day29.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day30 != null && Day30 != "")
            {
                ...
                //if (Day30.Equals(leaveTypeCode) || Day30.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day30.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
            ...
            if (Day31 != null && Day31 != "")
            {
                ...
                //if (Day31.Equals(leaveTypeCode) || Day31.Equals(nuagioSymbol + "+" + nuagioSymbol))
                //{
                //    countLeaveDays++;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
                //else if (Day31.Contains(nuagioSymbol))
                //{
                //    countLeaveDays = countLeaveDays + 0.5;
                //    listLeave.Add(new DateTime(year, month, 1));
                //}
        ...
        public static double CalculateLeaveDayL(string Day1, string Day2, string Day3, string Day4, string Day5, string Day6,
                 string Day7, string Day8, string Day9, string Day10, string Day11, string Day12, string Day13,
                 string Day14, string Day15, string Day16, string Day17, string Day18, string Day19, string Day20,
                 string Day21, string Day22, string Day23, string Day24, string Day25, string Day26, string Day27,
                 string Day28, string Day29, string Day30, string Day31, int leaveType)

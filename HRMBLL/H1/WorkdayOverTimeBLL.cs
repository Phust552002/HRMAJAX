...
namespace HRMBLL.H1
{
    public class WorkdayOverTimeBLL
    {
        ...
        private static WorkdayOverTimeBLL GenerateFromDataTable(DataRow dr, int itemLastIndex)
        {
            ...
            c._OverTimeHours = dr[WorkdayOverTimeKeys.Field_WorkdayOverTime_OverTimeHours] == DBNull.Value ? 0 : double.Parse(dr[WorkdayOverTimeKeys.Field_WorkdayOverTime_OverTimeHours].ToString());

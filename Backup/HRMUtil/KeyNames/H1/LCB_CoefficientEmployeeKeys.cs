...
namespace HRMUtil.KeyNames.H1
{
    sealed public class LCB_CoefficientEmployeeKeys
    {
        ...
        public const string Field_LCB_CoefficientEmployees_LCB_CoefficientEmployeeDescription = "LCB_CoefficientEmployeeDescription";
        ...
        public const string Sp_Del_H1_LCB_CoefficientEmployeeByEmployeeContractId = "Del_H1_LCB_CoefficientEmployeeByEmployeeContractId";

        public const string Sp_Sel_H1_LCB_CoefficientEmployee_By_UserId = "Sel_H1_LCB_CoefficientEmployee_By_UserId";
        public const string Sp_Sel_H1_LCB_CoefficientEmployee_By_EmployeeContractId = "Sel_H1_LCB_CoefficientEmployee_By_EmployeeContractId";        
        ...
        public const string Sp_Sel_H1_LCB_CoefficientEmployee_By_UserIdForNew = "Sel_H1_LCB_CoefficientEmployee_By_UserIdForNew";

        public const string Sp_Sel_H1_LCB_CoefficientEmployee_By_UserId_FromToDateFinal = "Sel_H1_LCB_CoefficientEmployee_By_UserId_FromToDateFinal";

...
namespace HRMUtil.KeyNames.H2
{
    public sealed class CandidateTrainingJobHistoryKeys
    {
        ...
        /// </summary>
        public const string Filed_CandidateTrainingJobHistory_CandidateTrainingJobHistoryId = "CandidateTrainingJobHistoryId";
        ...
        public const string Sp_Sel_H2_CandidateTrainingJobHistory_By_CandidateId_Type = "Sel_H2_CandidateTrainingJobHistory_By_CandidateId_Type";

...
namespace HRMUtil.KeyNames.H0
{
    public sealed class DepartmentEmployeeKeys
    {
        ...
        public const string Sp_Del_H0_DepartmentEmployees = "Del_H0_DepartmentEmployees";
        ...
        public const string Sp_Sel_H0_DepartmentEmployee_By_Root_LeaveDate = "Sel_H0_DepartmentEmployee_By_Root_LeaveDate";

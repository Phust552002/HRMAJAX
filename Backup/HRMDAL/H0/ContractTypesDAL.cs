...
namespace HRMDAL.H0
{
    public class ContractTypesDAL : Dao
    {
        ...
        public long Insert(string ContractTypeCode, string ContractTypeName, double ContractTypeValue, string ContractDescription, int DataType)
        {
        ...
        public long Update(string ContractTypeCode, string ContractTypeName, double ContractTypeValue, string ContractDescription, int ContractTypeId, int DataType)
        {

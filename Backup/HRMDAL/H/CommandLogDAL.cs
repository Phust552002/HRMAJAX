...
namespace HRMDAL.H
{
    public class CommandLogDAL : Dao
    {
        ...
        public long Insert(int commandTypeId, string dataName, int userId, string oldValues, string newValues, DateTime commandLogDate, int ModuleId)
        {
        ...
        public DataTable GetByFilter(string dataName, int commandTypeId, int userId, int Day, int Month, int Year, int ModuleId)
        {

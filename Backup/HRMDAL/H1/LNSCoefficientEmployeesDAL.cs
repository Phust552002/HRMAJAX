...
namespace HRMDAL.H1
{
    public class LNSCoefficientEmployeesDAL : Dao
    {
        ...
        /// <param name=""></param>
        /// <returns>int</returns>
        public long Insert(int employeeContractId, int userId, int coefficientValueId, double pCTN, double lNSWage, int lNSUnit, string description, DateTime createDate)
        {
            long identity = 0;
        ...
        public int Update(int lNS_CoefficientEmployeeId, int userId, int employeeContractId, int coefficientValueId, double pCTN, double lNSWage, int lNSUnit, string description, DateTime createDate, bool active)
        {
            int identity = 0;
            Debug.Assert(sproc == null);
            try
        ...
        public int DeleteByEmployeeContractId(int EmployeeContractId)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure(LNS_CoefficientEmployeeKeys.Sp_Del_H1_LNS_CoefficientEmployeeByEmployeeContractId, param);
        ...
        public DataTable GetByUserId(int UserId, int InUse)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure(LNS_CoefficientEmployeeKeys.SP_Sel_H1_LNS_CoefficientEmployee_By_UserId, param);
        ...
        public DataTable GetByEmployeeContractId(int EmployeeContractId)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure(LNS_CoefficientEmployeeKeys.Sp_Sel_H1_LNS_CoefficientEmployee_By_EmployeeContractId, param);
                sproc.RunFill(datatable);
                sproc.Dispose();
            }
            catch (SqlException se)
        ...
        public DataTable GetByUserIdForNew(int UserId)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure(LNS_CoefficientEmployeeKeys.Sp_Sel_H1_LNS_CoefficientEmployee_By_UserIdForNew, param);
                sproc.RunFill(datatable);
                sproc.Dispose();
            }
            catch (SqlException se)
        ...
        public DataTable GetByUserIdDate(int userId, DateTime createDate, int XQD)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure(LNS_CoefficientEmployeeKeys.Sp_Sel_H1_LNS_CoefficientEmployee_By_UserId_Date, param);
                sproc.RunFill(datatable);
                sproc.Dispose();
            }
            catch (SqlException se)

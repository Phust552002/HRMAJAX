    ...
    public class CoefficientNamePositionsDAL : Dao
    {
        ...
        public DataTable GetByNameId(int coefficientNameId)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure(CoefficientNamePositionKeys.SP_COEFFICIENT_NAME_POSITION_GET_BY_NAME_ID, param);
        ...
        public DataTable GetByPositionId(int positionId, int type)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure(CoefficientNamePositionKeys.SP_COEFFICIENT_NAME_POSITION_GET_BY_POSITION_ID, param);
                sproc.RunFill(datatable);

...
namespace HRMDAL.H2
{
    public class EducationLevelsDAL : Dao
    {
        ...
        public DataTable GetForForeignLanguageComputerDrivingLicense()
        {
            ...
            try
            {
                sproc = new StoreProcedure(EducationLevelKeys.Sp_Sel_H2_EducationLevel_By_ForeignLanguage_Computer_DrivingLicense, null);
                sproc.RunFill(datatable);
            }
            catch (SqlException se)
            {
        ...
        public DataTable GetById(int Id)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure("Sel_H2_EducationLevel_All_By_Id", param);
                sproc.RunFill(datatable);
            }
            catch (SqlException se)
            {

...
namespace HRMDAL.H2
{
    public class SessionsDAL : Dao
    {
        ...
        #region Methods Get
        public DataTable GetById1(int Id)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure("Sel_H2_SessionPosition_By_Id", param);
        ...
        public DataTable GetSessionIsOpenForPosition()
        {
            ...
            try
            {
                sproc = new StoreProcedure(SessionKeys.Sp_Sel_H2_SessionPosition_By_IsOpen_For_Position, null);
                sproc.RunFill(datatable);
            }
            catch (SqlException se)
            {
        ...
        public long Update(string name, DateTime fromDate, DateTime toDate, string remark, int sessionType, int sessionId)
        {

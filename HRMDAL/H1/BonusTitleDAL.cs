...
namespace HRMDAL.H1
{
    public class BonusTitleDAL : Dao
    {
        ...
        public DataTable GetByIds(string BonusTtileIds)
        {
            ...
            try
            {
                SqlParameter[] param =
                {
                    new SqlParameter("@BonusTitleIds", SqlDbType.VarChar, 254)
                };

                param[0].Value = BonusTtileIds;

                sproc = new StoreProcedure("Sel_H0_BonusTitles_By_Ids", param);
                sproc.RunFill(dt);
        ...
        //public DataTable GetAllTitle(int BonusVisible)
        //{
        ...
        //        SqlParameter[] param =
        //        {
        //            new SqlParameter("@BonusVisible", SqlDbType.Int)
        //        };

        //        param[0].Value = BonusVisible;

        //        sproc = new StoreProcedure("Sel_H0_BonusTitles_By_All_Ids", param);
        //        sproc.RunFill(dt);

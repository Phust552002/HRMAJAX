...
namespace HRMDAL.H1
{
    public class LCBCoefficientEmployeesDAL : Dao
    {
        ...
        /// <param name=""></param>
        /// <returns>int</returns>
        public long Insert(int EmployeeContractId, int UserId, int CoefficientValueId, double LCBwages, int LCBUnit, DateTime FromDate, DateTime ToDate, string Description, double PCDH, double PCTN, double PCCV, double PCKV)
        {
            long identity = 0;
        ...
        public int Update(int LCB_CoefficientEmployeeId, int UserId, int EmployeeContractId, int CoefficientValueId, double LCBwages, int LCBUnit, DateTime FromDate, DateTime ToDate, string Description, bool Active, double PCDH, double PCTN, double PCCV, double PCKV)
        {
            int identity = 0;
            Debug.Assert(sproc == null);
            try
        ...
        public int DeleteByEmployeeContractId(int EmployeeContractId)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure(LCB_CoefficientEmployeeKeys.Sp_Del_H1_LCB_CoefficientEmployeeByEmployeeContractId, param);
        ...
        public DataTable GetByUserId(int userId)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure(LCB_CoefficientEmployeeKeys.Sp_Sel_H1_LCB_CoefficientEmployee_By_UserId, param);
        ...
        public DataTable GetByEmployeeContractId(int EmployeeContractId)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure(LCB_CoefficientEmployeeKeys.Sp_Sel_H1_LCB_CoefficientEmployee_By_EmployeeContractId, param);
                sproc.RunFill(datatable);
            }
            catch (SqlException se)
            {
        ...
        public DataTable GetByUserIdForNew(int UserId)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure(LCB_CoefficientEmployeeKeys.Sp_Sel_H1_LCB_CoefficientEmployee_By_UserIdForNew, param);
                sproc.RunFill(datatable);
            }
            catch (SqlException se)
            {
        ...
        public DataTable RemindLCBCoefficient(string fullName, int deptId, int day, int month, int year)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure(LCB_CoefficientEmployeeKeys.Sp_Sel_H1_LCB_CoefficientEmployee_By_Remind, param);
                sproc.RunFill(dt);
        ...
        public DataTable ChangedLCBCoefficient(string fullName, int deptId, int day, int month, int year)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure(LCB_CoefficientEmployeeKeys.Sp_Sel_H1_LCB_CoefficientEmployee_By_Changed, param);
                sproc.RunFill(dt);
        ...
        public DataTable GetByUserIdFromToDateFinal(int UserId, DateTime FromDate, DateTime ToDate, int XQD)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure(LCB_CoefficientEmployeeKeys.Sp_Sel_H1_LCB_CoefficientEmployee_By_UserId_FromToDateFinal, param);
                sproc.RunFill(datatable);
            }
            catch (SqlException se)
            {

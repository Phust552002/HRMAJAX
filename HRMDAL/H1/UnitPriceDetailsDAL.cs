...
namespace HRMDAL.H1
{
    public class UnitPriceDetailsDAL : Dao
    {
        ...
        /// <param name=""></param>
        /// <returns>int</returns>
        public int Insert(double UnitPriceLNS, double UnitPriceBonus, double UnitPriceLCB, double UnitPriceLuch, int UnitPriceDeptId, DateTime CreateDate, string Remark, int UnitPriceType)
        {
            int identity = 0;
        ...
        public int Update(double UnitPriceLNS, double UnitPriceBonus, double UnitPriceLCB, double UnitPriceLuch, int UnitPriceDeptId, DateTime CreateDate, string Remark, int UnitPriceType, int UnitPriceDetailId)
        {
            int identity = 0;
            Debug.Assert(sproc == null);
            try

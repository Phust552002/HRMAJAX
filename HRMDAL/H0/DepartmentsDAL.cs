...
namespace HRMDAL.H0
{
    public class DepartmentsDAL : Dao
    {
        ...
        public long Insert(int parentId, string departmentCode, string departmentName, string departmentNameE, string description)
        {
        ...
        public long Update(string departmentCode, string departmentName, string departmentNameE, string description, int departmentId)
        {

...
namespace HRMDAL.H0
{
    public class RoleUsersDAL : Dao
    {
        ...
        public DataTable GetByRoleId_RootId(int roleId, int rootId)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure("Sel_H0_UserRoles_By_RootId", param);
                sproc.RunFill(dt);
            }
            catch (SqlException se)
            {
        ...
        public DataTable GetRoleByDepartment(int departmentId)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure("Sel_H0_Roles_By_DepartmentId", param);
                sproc.RunFill(dt);
            }
            catch (SqlException se)
            {
        ...
        public DataTable GetByFilter(string FullName, string RoleIds, string DepartmentIds)
        {
            ...
            try
            {
                SqlParameter[] param = 
				{
                    ...
                    new SqlParameter("@DepartmentIds",SqlDbType.VarChar, 2000)
				};
        ...
        public long Insert(System.Nullable<int> UserId, System.Nullable<int> RoleId)
        {
            ...
            try
            {
                ...
                {
                    param[1].Value = ((int)(RoleId.Value));
                }
                else
                {
        ...
        public long UpdateByRole(System.Nullable<int> UserId, System.Nullable<int> RoleId)
        {
        ...
        public long UpdateByUser(System.Nullable<int> UserId, System.Nullable<int> RoleId)
        {
            ...
            try
            {
                ...
                if ((RoleId.HasValue == true))
                {
                    param[0].Value = ((int)(RoleId.Value));
                }
                else
                {
                    param[0].Value = System.DBNull.Value;
        ...
        public long Delete(System.Nullable<int> UserId, System.Nullable<int> RoleId)
        {
        ...
        public long DeleteByUser(System.Nullable<int> UserId)
        {
        ...
        public long DeleteByRole(System.Nullable<int> RoleId)
        {

...
namespace HRMDAL.H0
{
    public class EmployeeTimeBillDAL: Dao
    {
        ...
        public DataTable GetLogByUserIdAndDate(int userId, DateTime selectedDate)
        {
            Debug.Assert(sproc == null);
            ...
            try
            {
                ...
                param[1].Value = selectedDate;

                sproc = new StoreProcedure(EmployeeTimeBillKeys.Sp_Sel_H0_EmployeeTimeBill_Log_ByUserId_WorkDate, param);
                sproc.RunFill(dt);
            }
            catch (SqlException se)
            {
        ...
        public DataTable GetByDateDepartmentId(string FullName, System.Nullable<int> DeptId, DateTime InputDate)
        {
            ...
            try
            {
                ...
                {
                    param[1].Value = ((int)(DeptId.Value));
                }
                else
                {
                    param[1].Value = System.DBNull.Value;
                ...
                param[2].Value = InputDate;

                sproc = new StoreProcedure(EmployeeTimeBillKeys.Sp_Sel_H0_EmployeeTimeBillByDeptDate, param);
                sproc.RunFill(dt);
            }
            catch (SqlException se)
            {

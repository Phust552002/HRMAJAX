...
namespace HRMDAL.H0
{
    public class EmployeeLeaveDAL : Dao
    {
        ...
        #region Get
        public DataTable GetLeaveInfoById(int userId)
        {
            Debug.Assert(sproc == null);
            ...
            try
            {
                ...
                param[0].Value = userId;
                sproc = new StoreProcedure("Sel_H0_EmployeeLeave_Info_By_UserId", param);
                sproc.RunFill(dt);
            }
            catch (SqlException se)
            {
        ...
        public DataTable GetRealLeaveByUserId(int userId, int month, int year)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure("Sel_H0_EmployeeLeave_By_UserId_Include_Total_2", param);
                sproc.RunFill(dt);
            }
            catch (SqlException se)
            {
        ...
        public DataTable GetRealLeaveByUserId2(int userId,int year)
        {
        ...
        public DataTable GetLeaveReportByUserId(int userId, int year)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure("Sel_H0_EmployeeLeave_By_UserIds_Year", param);
                sproc.RunFill(dt);
            }
            catch (SqlException se)
            {

...
namespace HRMDAL.H
{
    public class EmployeeIncomeDAL : Dao
    {
        ...
        public DataTable GetByFilter(string fullName, string departmentIds, int rootId, int month, int year)
        {
            ...
            try
            {
                ...
                {
                    new SqlParameter("@FullName",SqlDbType.NVarChar,100),
                    new SqlParameter("@DepartmentIds",SqlDbType.VarChar),
                ...
                sproc = new StoreProcedure("Sel_H_EmployeeIncomeByFilter2", param);
                sproc.RunFill(datatable);
        ...
        public DataTable GetStatisticTotalByFilter(string departmentIds, int rootId, int month, int year)
        {
            ...
            try
            {
                ...
                SqlParameter[] param =
                {
                    new SqlParameter("@DepartmentIds",SqlDbType.VarChar, 100),
                    new SqlParameter("@RootId",SqlDbType.Int),
                    new SqlParameter("@Month",SqlDbType.Int),
                    new SqlParameter("@Year",SqlDbType.Int)
                };
                ...
                sproc = new StoreProcedure("Sel_H_EmployeeIncomeForStatisticTotalByFilter2", param);
                sproc.RunFill(datatable);
        ...
        public long Insert(string userCode, double total_Inc, double total_Cntr, double total_Real, double total_Inc_LK, double total_Cntr_LK, DateTime date, int userId)
        {
            long identity = 0;
            Debug.Assert(sproc == null);
            try

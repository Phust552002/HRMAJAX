...
namespace HRMDAL.H
{
    public class IncomesMonthDAL :Dao
    {
        ...
        /// <param name=""></param>
        /// <returns>int</returns>
        public long Insert(int incomeTypeId, bool type, string userCode, double value, DateTime date, int UserId)
        {
            long identity = 0;
        ...
        public DataTable GetAllByUserId_Paid_Monthly_By_All(int userId, int month, int year)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure("Sel_H1_PaidIncomeMonthAll_ByUserId_Monthly", param);
                sproc.RunFill(datatable);
        ...
        public DataTable GetAllByUserId_Bonus_Monthly_By_All(int userId, int year)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure("Sel_H1_Bonus_ByUserId_Monthly", param);
                sproc.RunFill(datatable);
        ...
        public DataTable GetAllByUserId_Monthly_By_All(int userId, int month, int year)
        {
            ...
            try
            {
                ...
                sproc = new StoreProcedure("Sel_H1_IncomeMonthAll_ByUserId_Monthly", param);
                sproc.RunFill(datatable);

<%@ Page Language="C#" MasterPageFile="~/HRM-PM.master" AutoEventWireup="true" CodeFile="PMemberLeaveList.aspx.cs" Inherits="PMember_PMemberLeaveList" Title="SAGS :: HUMAN RESOURCES MANAGEMENT" %>
                                                ...
                                                <td>
                                                    <asp:GridView ID="grdEmployeesList" runat="server" AllowPaging="True" AllowSorting="True"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField SortExpression="DateJoinP" HeaderText="Ngày vào Đảng">
                                                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                                <ItemTemplate>
                                                                <asp:Label runat="server" id="lbDateJoinP"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField SortExpression="DateJoinPOfficial" HeaderText="Ngày vào Đảng chính thức">
                                                                <ItemTemplate>
                                                                <asp:Label id="lbDateJoinPOfficial" runat="server"></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                    ...
                                                    <asp:ObjectDataSource ID="odsEmployees" runat="server" OldValuesParameterFormatString="original_{0}"
                                                        OnSelected="odsEmployees_Selected" OnSelecting="odsEmployees_Selecting" SelectMethod="GetPMembersLeaveByDeptIds"
                                                        SortParameterName="sortParameter" TypeName="HRMBLL.H6.PMembersBLL">
                                                        <SelectParameters>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="JobHistory.ascx.cs" Inherits="Employee_UserControls_Working_JobHistory" %>
...
<table style="width: 100%" class="tableBorder">
 <tr>
    <td>
        <asp:DataList ID="dlJobHistory" runat="server" Width="100%" OnItemDataBound="dlDataListInsert_ItemDataBound">
            <HeaderTemplate>
                <table style="width: 100%" cellpadding="0" cellspacing="0">
                    <tr class="dataList-header">
                        <td style="width:8%" align="left">Từ năm</td>                                                                        
                        <td style="width:8%" align="left">Đến năm</td>
                        <td style="width:64%" align="left">Làm gì, ở đâu</td>                                                                                                                        

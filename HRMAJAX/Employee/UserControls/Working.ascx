<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Working.ascx.cs" Inherits="Employee_UserControls_Working" %>
<%@ Register Src="Working/Reward.ascx" TagName="Reward" TagPrefix="uc3" %>
<%@ Register Src="Working/BreachOfDiscipline.ascx" TagName="BreachOfDiscipline" TagPrefix="uc4" %>
<%@ Register Src="Working/JobHistory.ascx" TagName="JobHistory" TagPrefix="uc2" %>
                                                        ...
                                                        <asp:MultiView ID="MultiTabs" runat="server">
                                                            <asp:View ID="Tab0" runat="server">
                                                                <table style="width: 100%">
                                                                    <tr>
                                                                        <td>                                                                        
                                                                            <uc2:JobHistory ID="JobHistory1" runat="server" />
                                                            ...
                                                            <asp:View ID="Tab1" runat="server">
                                                                <table style="width: 100%">
                                                                    <tr>
                                                                        <td>
                                                                            <uc3:Reward ID="Reward1" runat="server" />
                                                            ...
                                                            <asp:View ID="Tab2" runat="server">
                                                                <table style="width: 100%">
                                                                    <tr>
                                                                        <td>
                                                                            <uc4:BreachOfDiscipline ID="BreachOfDiscipline1" runat="server" />

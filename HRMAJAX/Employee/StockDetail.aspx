<%@ Page Title="" Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="StockDetail.aspx.cs" Inherits="Employee_StockDetail" %>
                    ...
                    <td valign="top" >
                        <table style="width: 99%;margin-top:2px; margin-left:2px; margin-right:2px;" class="tableBorder">
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdValue">
                                            <asp:TextBox ID="txtIDCard" runat="server" CssClass="textBox" Width="150px"></asp:TextBox>
                                         </td>
                                    </tr>
                                    <tr>
                                         <td class="tdLabel">
                                        ...
                                        <td class="tdValue">                                            
                                            <uc3:CalendarPicker ID="cpDateOfIssue" runat="server" />                                            
                                        </td>                                        
                                    </tr>
                                    <tr>
                                         <td class="tdLabel">
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdValue">
                                            <asp:TextBox ID="txtSeniorStockBought" runat="server" CssClass="textBoxNumber" Width="50px"></asp:TextBox><asp:Label ID="Label6" runat="server" CssClass="label" Text=" x "></asp:Label><asp:TextBox ID="TextBox3" runat="server" CssClass="textBoxNumber" Width="50px"  ReadOnly="true" Text="8,400"></asp:TextBox><asp:Label ID="Label14" runat="server" CssClass="label" Text=" = "></asp:Label><asp:TextBox ID="txtSeniorStockBoughtMoney" runat="server" CssClass="textBoxNumber" Width="100px"  ReadOnly="true"></asp:TextBox></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdValue">
                                            <asp:TextBox ID="txtUnderTakingStockBought" runat="server" CssClass="textBoxNumber" Rows="3" Width="50px"></asp:TextBox><asp:Label ID="Label8" runat="server" CssClass="label" Text=" x "></asp:Label><asp:TextBox ID="TextBox4" runat="server" CssClass="textBoxNumber" Width="50px"  ReadOnly="true" Text="14,000"></asp:TextBox><asp:Label ID="Label15" runat="server" CssClass="label" Text=" = "></asp:Label><asp:TextBox ID="txtUnderTakingStockBoughtMoney" runat="server" CssClass="textBoxNumber" Width="100px"  ReadOnly="true"></asp:TextBox></td>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td class="tdValue">                                            
                                            <uc3:CalendarPicker ID="cpStockDateOfPayment" runat="server" />                                            
                                        </td>                                        
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdValue">
                                            <asp:TextBox ID="txtStockRemark" runat="server" Width="98%" CssClass="textBox" TextMode="MultiLine" Rows="3"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                         <td class="tdLabel">
                                        ...
                                        <td class="tdValue">                                            
                                            <asp:CheckBox ID="chkCash" runat="server" CssClass="value" 
                                                Text="Nộp tiền mặt" TextAlign="Left" />
                                        &nbsp;&nbsp;                                            
                                            <asp:CheckBox ID="chkBanking" runat="server" CssClass="value" 
                                                Text="Chứng từ thanh toán ngân hàng" TextAlign="Left" />
                                        </td>                                        
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="tdButton">
                                                ...
                                                <tr>                                                        
                                                    <td align="center">
                                                        ...
                                                        &nbsp;&nbsp;
                                                        <asp:Button ID="btnPrint" runat="server" Text="In Phiếu" CssClass="small color green button" 
                                                            Width="100px"
                                                            OnClick="btnPrint_Click" />&nbsp; &nbsp;<asp:Button ID="btnCancel" runat="server" Text="Thoát" CssClass="small color green button" Width="100px" OnClick="btnCancel_Click" />
                                                        </td>
                                                    </tr>
                                            </table>

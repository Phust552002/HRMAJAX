<%@ Page Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="AddDefault.aspx.cs" Inherits="Employee_AddDefault" Title="SAGS :: HUMAN RESOURCES MANAGEMENT" %>
                 ...
                 <td style="width:30%" valign="top" class="tdTreeView" align="left">
                    ...
                    <fieldset>
                        ...
                        <table style="width: 100%" class="tableBorder">                                    
                            ...
                            <tr>
                                <td align="left" class="tdLabel"><asp:Label ID="Label4" runat="server" CssClass="label" Text="Điện thoại nhà"></asp:Label></td>
                                <td align="left" class="tdValue">
                                    <asp:TextBox ID="txtHomePhone" runat="server" CssClass="textBox" Width="100px"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td align="left" class="tdLabel"><asp:Label ID="Label6" runat="server" 
                                        CssClass="label" Text="Trình độ cao nhất"></asp:Label></td>
                                <td align="left" class="tdValue">
                                     <asp:DropDownList ID="ddlEducationLevel" runat="server" CssClass="dropDownList" DataSourceID="ObjectDataSource2" DataTextField="Name" DataValueField="Id"  AppendDataBoundItems="true">
                                          <asp:ListItem Text="" Value="0"></asp:ListItem>
                                     </asp:DropDownList>&nbsp; <asp:TextBox ID="TextBox1" runat="server" CssClass="textBox" Width="100px"></asp:TextBox> <asp:Label ID="Label7" runat="server" 
                                        CssClass="label" Text="Ghi chú: "></asp:Label> <asp:TextBox ID="TextBox2" runat="server" CssClass="textBox" Width="100px"></asp:TextBox>
                                     <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetAll" TypeName="HRMBLL.H2.EducationLevelsBLL"></asp:ObjectDataSource>
                                </td>
                            </tr>
                            <tr>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BQDLReport.aspx.cs" Inherits="ShareHolder_BQDLReport" %>
                        ...
                        <tr>
                            <td class="tdLabel">
                                ...
                                <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" 
                                    SelectMethod="GetForStatisticByBQ_DL2" 
                        ...
                        <tr>
                            <td class="tdLabel" style="width:40%">
                                ...
                                <SelectedRowStyle CssClass="grid-SelectedRowStyle"></SelectedRowStyle>
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Col3" 
                                            HeaderText="THÔNG QUA ĐIỀU LỆ TỔ CHỨC VÀ HOẠT ĐỘNG CỦA CÔNG TY">
                                ...
                                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                    SelectMethod="GetForStatisticByBQ_DL" 
                                    TypeName="HRMBLL.H4.RepresentativeBLL" 
                                    OldValuesParameterFormatString="original_{0}">
                                </asp:ObjectDataSource>
                                </td>                                                       

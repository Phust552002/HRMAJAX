<%@ Page Title="" Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="BQDLList.aspx.cs" Inherits="ShareHolder_BQDLList" %>
                                            ...
                                            <HeaderTemplate>
                                                <table style="width:100%" cellpadding="0" cellspacing="1">
                                                    <tr class="grid-header1" >
                                                        ...
                                                        <td align="center" style="width:100px">
                                                            XÁC NHẬN</td>                                                                                                             
                                                        <td align="center">
                                                            THÔNG QUA ĐIỀU LỆ TỔ CHỨC VÀ HOẠT ĐỘNG CỦA CÔNG TY</td>
                                                         <td align="center" style="width:100px">
                                                            PHIẾU</td>
                                                    </tr>
                                            </HeaderTemplate>
                                             <ItemTemplate>
                                                <tr class="grid-item">
                                                    ...
                                                    <td align="center">                                                    
                                                        <asp:Label ID="lbBQ_DL" CssClass="value" runat="server"></asp:Label>
                                                       </td>
                                                    <td align="center">                                                    
                                                        <asp:Label ID="lbBQ_DL_IsValid" CssClass="value" runat="server"></asp:Label>
                                                       </td>
                                                </tr>
                                            </ItemTemplate>

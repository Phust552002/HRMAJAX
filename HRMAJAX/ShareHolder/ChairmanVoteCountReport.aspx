<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChairmanVoteCountReport.aspx.cs" Inherits="ShareHolder_ChairmanVoteCountReport" %>
                        ...
                        <tr>
                            <td class="tdLabel">
                                ...
                                <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" 
                                    SelectMethod="GetForStatisticByHDQT2" 
                        ...
                        <tr>
                            <td class="tdLabel" style="width:40%">
                                ...
                                <SelectedRowStyle CssClass="grid-SelectedRowStyle"></SelectedRowStyle>
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Col4" 
                                            HeaderText="Tỷ lệ CP bỏ phiếu hợp lệ (đã quy đổi)/Tổng số CP tham gia bầu cử quy đổi">
                                        <ItemStyle Width="20%" HorizontalAlign="Right" />
                                        </asp:BoundField>
                                    </Columns>
                                <FooterStyle CssClass="grid-footer"></FooterStyle>
                                ...
                                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                    SelectMethod="GetForStatisticByHDQT" 
                                    TypeName="HRMBLL.H4.RepresentativeBLL">
                                </asp:ObjectDataSource>
                                </td>                                                       
                        </tr>                      

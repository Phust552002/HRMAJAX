<%@ Page Title="" Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="BQKDTLKTNYAdd.aspx.cs" Inherits="ShareHolder_BQKDTLKTNYAdd" %>
                                            ...
                                            <HeaderTemplate>
                                             ...
                                             <ItemTemplate>
                                                <tr class="grid-item">
                                                    ...
                                                    <td align="center">
                                                         <asp:DropDownList ID="ddlBQ_KD" runat="server" CssClass="dropDownList">                                                                                                                
                                                        <asp:ListItem Value="1" Text="Đồng ý"></asp:ListItem>
                                                        <asp:ListItem Value="0" Text="Không đồng ý"></asp:ListItem>
                                                        <asp:ListItem Value="2" Text="Không có ý kiến"></asp:ListItem>
                                                        <asp:ListItem Value="-1" Text="--"></asp:ListItem>
                                                     ...
                                                     <td align="center">
                                                         <asp:DropDownList ID="ddlBQ_TL" runat="server" CssClass="dropDownList">                                                                                                                
                                                        <asp:ListItem Value="1" Text="Đồng ý"></asp:ListItem>
                                                        <asp:ListItem Value="0" Text="Không đồng ý"></asp:ListItem>
                                                        <asp:ListItem Value="2" Text="Không có ý kiến"></asp:ListItem>
                                                        <asp:ListItem Value="-1" Text="--"></asp:ListItem>
                                                     ...
                                                     <td align="center">
                                                         <asp:DropDownList ID="ddlBQ_KT" runat="server" CssClass="dropDownList">                                                                                                                
                                                        <asp:ListItem Value="1" Text="Đồng ý"></asp:ListItem>
                                                        <asp:ListItem Value="0" Text="Không đồng ý"></asp:ListItem>
                                                        <asp:ListItem Value="2" Text="Không có ý kiến"></asp:ListItem>
                                                        <asp:ListItem Value="-1" Text="--"></asp:ListItem>
                                                     ...
                                                     <td align="center">
                                                         <asp:DropDownList ID="ddlBQ_NY" runat="server" CssClass="dropDownList">                                                                                                                
                                                        <asp:ListItem Value="1" Text="Đồng ý"></asp:ListItem>
                                                        <asp:ListItem Value="0" Text="Không đồng ý"></asp:ListItem>
                                                        <asp:ListItem Value="2" Text="Không có ý kiến"></asp:ListItem>
                                                        <asp:ListItem Value="-1" Text="--"></asp:ListItem>
                                                    ...
                                                    <td align="center">
                                                        <asp:DropDownList ID="ddlBQ_KDTLKTNY_IsValid" runat="server" CssClass="dropDownList">                                                                                                                

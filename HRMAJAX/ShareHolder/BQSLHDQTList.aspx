<%@ Page Title="" Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="BQSLHDQTList.aspx.cs" Inherits="ShareHolder_BQSLHDQTList" %>
                                            ...
                                            <HeaderTemplate>
                                                <table style="width:100%" cellpadding="0" cellspacing="1">
                                                    <tr class="grid-header1" >
                                                        ...
                                                        <td align="center" style="width:100px">
                                                            XÁC NHẬN</td>                                                                                                             
                                                        <td align="center">
                                                            THÔNG QUA SỐ LƯỢNG HỘI ĐỒNG QUẢN TRỊ</td>
                                                         <td align="center" style="width:100px">
                                                            PHIẾU</td>
                                                    </tr>
                                            </HeaderTemplate>
                                             <ItemTemplate>
                                                <tr class="grid-item">
                                                    ...
                                                    <td align="center">                                                    
                                                        <asp:Label ID="lbBQ_SLHDQT" CssClass="value" runat="server"></asp:Label>
                                                       </td>
                                                     <td align="center">                                                    
                                                        <asp:Label ID="lbBQ_SLHDQT_IsValid" CssClass="value" runat="server"></asp:Label>
                                                       </td>
                                                </tr>
                                            </ItemTemplate>

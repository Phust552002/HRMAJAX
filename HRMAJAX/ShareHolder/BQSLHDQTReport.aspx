<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BQSLHDQTReport.aspx.cs" Inherits="ShareHolder_BQSLHDQTReport" %>
                        ...
                        <tr>
                            <td class="tdLabel">
                                ...
                                <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" 
                                    SelectMethod="GetForStatisticByBQ_SLHDQT2" 
                        ...
                        <tr>
                            <td class="tdLabel" style="width:40%">
                                ...
                                <SelectedRowStyle CssClass="grid-SelectedRowStyle"></SelectedRowStyle>
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Col3" 
                                            HeaderText="BIỂU QUYẾT THÔNG QUA SỐ LƯỢNG HỘI ĐỒNG QUẢN TRỊ">
                                ...
                                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                    SelectMethod="GetForStatisticByBQ_SLHDQT" 
                                    TypeName="HRMBLL.H4.RepresentativeBLL" 
                                    OldValuesParameterFormatString="original_{0}">
                                </asp:ObjectDataSource>
                                </td>                                                       

...
public partial class ShareHolder_ChairmanVoteCountReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            UcTitle1.Text = "KẾT QUẢ BẦU CỬ HỘI ĐỒNG QUẢN TRỊ";
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (row.RowType == DataControlRowType.DataRow)
        {
            try
            {
                ...
                row.Cells[2].Text = result2.ToString("#,###0");
            }

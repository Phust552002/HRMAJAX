<%@ Page Title="" Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="ChairmanVoteCountList.aspx.cs" Inherits="ShareHolder_ChairmanVoteCountList" %>
                             ...
                             <td style="width:20%" align="left">                                                                       
                                ...
                                <td align="right">
                                        ...
                                        &nbsp; &nbsp;&nbsp;--%><asp:Button ID="imgSearch" runat="server"
                                            CssClass="small color green button" Text="Xem" OnClick="imgSearch_Click" Width="100px"/>
                         ...
                         <tr>
                            <td>
                                            ...
                                            <HeaderTemplate>
                                             ...
                                             <ItemTemplate>
                                                <tr class="grid-item">
                                                    ...
                                                    <td align="left">
                                                        <asp:Label ID="lbFullName" CssClass="value" runat="server"></asp:Label></td>
                                                    <td align="right">
                                                    ...
                                                    <td align="center">
                                                        <asp:Label ID="lbHDQT_IsValid" CssClass="value" runat="server"></asp:Label></td>
                                                   <%-- <td align="right">
                                ...
                                <asp:ObjectDataSource ID="odsRepresentative" runat="server" OnSelecting="odsRepresentative_Selecting"
                                    ...
                                    onselected="odsRepresentative_Selected">
                                    <SelectParameters>

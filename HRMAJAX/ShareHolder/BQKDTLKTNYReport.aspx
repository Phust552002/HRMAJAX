<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BQKDTLKTNYReport.aspx.cs" Inherits="ShareHolder_BQKDTLKTNYReport" %>
                        ...
                        <tr>
                            <td class="tdLabel">
                                ...
                                <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" 
                                    SelectMethod="GetForStatisticByBQ_KDTLKTNY2" 
                        ...
                        <tr>
                            <td class="tdLabel" style="width:40%">
                                ...
                                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                    SelectMethod="GetForStatisticByBQ_KDTLKTNY" 
                                    TypeName="HRMBLL.H4.RepresentativeBLL" 
                                    OldValuesParameterFormatString="original_{0}">
                                </asp:ObjectDataSource>
                                </td>                                                       

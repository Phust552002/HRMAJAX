<%@ Page Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="InputFixedUnitPrices.aspx.cs" Inherits="CalculatedSalary_Fixed_UnitPrices_InputFixedUnitPrices" Title="SAGS :: HUMAN RESOURCES MANAGEMENT" %>
            ...
            <table style="width: 100%" >
                        ...
                        <td align="center">
                            <table style="width: 100%" class="tableBorder">
                                <tr>
                                    ...
                                    <asp:ObjectDataSource ID="odsUnitPriceDetails" runat="server" SelectMethod="GetByFilter"
                                        TypeName="HRMBLL.H1.UnitPriceDetailsBLL" DeleteMethod="Delete" OnSelecting="odsUnitPriceDetails_Selecting" OnSelected="odsUnitPriceDetails_Selected" UpdateMethod="Update" OnUpdating="odsUnitPriceDetails_Updating" OldValuesParameterFormatString="original_{0}">
                                        <DeleteParameters>
                    ...
                    <tr>
                        <td class="tdButton" align="center">
                            <asp:Button ID="btnAddNew" runat="server" CssClass="small color green button" OnClick="btnAddNew_Click" Text="Nhập Đơn Giá Cố Định" />            <asp:Button ID="btnCalculated" runat="server" CssClass="small color green button" Text="Tính lương" OnClick="btnCalculated_Click" />
                        </td>
                    </tr>
                </table>
        </td>

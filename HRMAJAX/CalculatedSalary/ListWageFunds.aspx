    ...
    <tr>
        <td align="center">
            <asp:UpdatePanel id="UpdatePanel1" runat="server">
              <ContentTemplate>
<TABLE style="WIDTH: 100%"><TBODY><TR><TD vAlign=top><TABLE style="WIDTH: 100%"><TBODY><TR><TD align=center><asp:Label id="Label3" runat="server" CssClass="label" Text="Tháng năm"></asp:Label> <asp:DropDownList id="ddlMonths" runat="server" CssClass="dropDownList" OnSelectedIndexChanged="ddlMonths_SelectedIndexChanged" AutoPostBack="True">
            ...
            </asp:DropDownList><asp:DropDownList id="ddlYears" runat="server" CssClass="dropDownList" OnSelectedIndexChanged="ddlYears_SelectedIndexChanged" AutoPostBack="True">
            </asp:DropDownList></TD></TR><TR><TD><TABLE style="WIDTH: 100%" class="tableBorder"><TBODY><TR><TD><asp:GridView id="grdWagwFunds" runat="server" Width="100%" CssClass="grid-Border" AutoGenerateColumns="False" OnRowDataBound="grdWagwFunds_RowDataBound" DataSourceID="ObjectDataSource1" DataKeyNames="WageFundId"><Columns>
...
</asp:GridView></TD></TR></TBODY></TABLE><asp:ObjectDataSource id="ObjectDataSource1" runat="server" OnSelected="ObjectDataSource1_Selected" OnSelecting="ObjectDataSource1_Selecting" SelectMethod="GetByCreateDate" TypeName="HRMBLL.H1.WageFundsBLL" OnUpdating="ObjectDataSource1_Updating" UpdateMethod="UpdateByOriginalWageFund"><UpdateParameters>

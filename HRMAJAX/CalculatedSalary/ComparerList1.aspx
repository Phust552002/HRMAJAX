<%@ Page Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="ComparerList1.aspx.cs" Inherits="CalculatedSalary_ComparerList1" Title="Untitled Page" %>
                                ...
                                <tr>
                                    <td valign="top">
                                        <table class="tableBorder">
                                            <tr>
                                                <td><asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1"

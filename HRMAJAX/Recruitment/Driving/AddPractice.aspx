<%@ Page Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="AddPractice.aspx.cs" Inherits="Recruitment_Driving_AddPractice" Title="SAGS :: HUMAN RESOURCES MANAGEMENT" %>
                            ...
                            <td>
                                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Luật GTĐB">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="LT &#212;t&#244; Cơ Bản ">
                                            <ItemTemplate>
                                                <asp:Label ID="lbNNGK2" runat="server"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" />
                                            <HeaderStyle HorizontalAlign="Center" />
                                        </asp:TemplateField>
                                          <asp:TemplateField HeaderText="Thực H&#224;nh">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtNNGK3" runat="server" CssClass="textBox" Width="40px"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" />
                                            <HeaderStyle HorizontalAlign="Center" />
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Điểm Trung B&#236;nh">
                                            <ItemTemplate>
                                                <asp:Label ID="lbNNTB" runat="server"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" />
                                            <HeaderStyle HorizontalAlign="Center" />
                                        </asp:TemplateField>

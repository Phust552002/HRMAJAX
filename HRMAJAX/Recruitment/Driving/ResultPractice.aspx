<%@ Page Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="ResultPractice.aspx.cs" Inherits="Recruitment_Driving_ResultPractice" Title="SAGS :: HUMAN RESOURCES MANAGEMENT" %>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="LT &#212;t&#244; Cơ Bản ">
                                          ...
                                          <asp:TemplateField HeaderText="Thực H&#224;nh">
                                            <ItemTemplate>
                                                <asp:Label ID="lbNNGK3" runat="server"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" />
                                            <HeaderStyle HorizontalAlign="Center" />
                                        </asp:TemplateField>

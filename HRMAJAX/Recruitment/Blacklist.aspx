<%@ Page Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="Blacklist.aspx.cs" Inherits="Recruitment_Blacklist" Title="SAGS :: HUMAN RESOURCES MANAGEMENT" %>
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <td align="right" style="width: 90%">
                                        <asp:Label ID="Label3" CssClass="label" runat="server" Text="Đợt " 
                                            Visible="False"></asp:Label>&nbsp;<asp:DropDownList
                                                                                                                                 
                                            ID="ddlSessions" runat="server" CssClass="dropDownList" AutoPostBack="True" 
                                            OnSelectedIndexChanged="ddlSessions_SelectedIndexChanged" Width="200px" 
                                            Visible="False">
                                        </asp:DropDownList>

                                        &nbsp;
                                        <asp:Label ID="Label2" CssClass="label" runat="server" Text="Chức danh" 
                                            Visible="False"></asp:Label>
                                        <asp:DropDownList ID="ddlPositions" runat="server" CssClass="dropDownList" 
                                            AppendDataBoundItems="True" Width="100px" Visible="False">
                                    ...
                                    <td>
                                        ...
                                        <asp:ObjectDataSource ID="odsCandidateList" runat="server" OnSelecting="odsCandidateList_Selecting"
                                            ...
                                            <SelectParameters>
                                                ...
                                                <asp:Parameter Name="positionId" Type="Int32" DefaultValue="0"/>
                                                <asp:Parameter Name="result" Type="Int32" DefaultValue=""/>
                                                <asp:Parameter Name="sessionId" Type="Int32" DefaultValue="0"/>
                                                <asp:Parameter Name="type" Type="Int32" DefaultValue="-1"/>
                                                <asp:Parameter Name="sessionType" Type="Int32" DefaultValue="0"/>
                                                <asp:Parameter Name="TypeSort" Type="Int32" DefaultValue="0"/>
                                                <asp:Parameter DefaultValue="1" Name="isBlack" Type="Int32" />
                                            </SelectParameters>
                                        </asp:ObjectDataSource>
                                    </td>
                                </tr>

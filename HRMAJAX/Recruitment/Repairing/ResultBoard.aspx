<%@ Page Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="ResultBoard.aspx.cs" Inherits="Recruitment_Repairing_ResultBoard" Title="Untitled Page" %>
                                            ...
                                            <HeaderTemplate>
                                             ...
                                             <ItemTemplate>
                                                <tr class="grid-item">
                                                    ...
                                                    <td align="center">
                                                        <asp:Label ID="lbDHGK3" CssClass="value" runat="server"></asp:Label></td>
                                                    <td align="center">
                                                        <asp:Label ID="lbDHTB" CssClass="value-bold" runat="server"></asp:Label></td>                                                                   
                                                    <td align="left">

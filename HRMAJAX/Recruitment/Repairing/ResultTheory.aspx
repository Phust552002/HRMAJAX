<%@ Page Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="ResultTheory.aspx.cs" Inherits="Recruitment_Repairing_ResultTheory" Title="SAGS :: HUMAN RESOURCES MANAGEMENT" %>
                                ...
                                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Họ v&#224; t&#234;n l&#243;t">
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lbLastName" runat="server" CssClass="value" Text='<%# Eval("LastName") %>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="T&#234;n">
                                            ...
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label ID="lbFirstName" runat="server" CssClass="value-bold" Text='<%# Eval("FirstName") %>' ToolTip='<%# Eval("Id") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Ghi chú">
                                            <ItemTemplate>
                                                <asp:Label ID="lbRemark1" runat="server" Text="Label"></asp:Label>
                                            </ItemTemplate>

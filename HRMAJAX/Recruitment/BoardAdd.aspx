<%@ Page Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="BoardAdd.aspx.cs" Inherits="Recruitment_BoardAdd" Title="Untitled Page" %>
        ...
        <table style="width: 100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td style="BACKGROUND-COLOR: #cccc99" valign="top" align="center"> 
                    <asp:ImageButton id="imgSave" onclick="imgSave_Click" runat="server" ImageUrl="~/Images/icon-save.gif"></asp:ImageButton><asp:Label id="lbSave" runat="server" CssClass="label" Text="Lưu"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="left">
                                            ...
                                            <HeaderTemplate>
                                             ...
                                             <ItemTemplate>
                                                <tr class="grid-item">
                                                    ...
                                                    <td align="center">
                                                        <asp:TextBox ID="txtNNLRTB" Width="30px" CssClass="value" runat="server"></asp:TextBox></td>
                                                    <%--<td align="center">
                                                    ...
                                                    <td align="center">
                                                        <asp:TextBox ID="txtNHLRTB" Width="30px" CssClass="value" runat="server"></asp:TextBox></td>
                                                    <%--<td align="center">
                                                        <asp:TextBox ID="txtDHGK2" Width="30px" CssClass="value" runat="server"></asp:TextBox></td>    --%>
                                                    <td align="center">
                                                        <asp:TextBox ID="txtRemark" Width="98%" CssClass="value" runat="server"></asp:TextBox></td>
                                                    <td align="center">
            ...
            <tr>
                <td style="BACKGROUND-COLOR: #cccc99" valign="top" align="center">
                    <asp:ImageButton id="imgSave1" onclick="imgSave_Click" runat="server" ImageUrl="~/Images/icon-save.gif"></asp:ImageButton><asp:Label id="lbSave1" runat="server" CssClass="label" Text="Lưu"></asp:Label>
                </td>
            </tr>
        </table>

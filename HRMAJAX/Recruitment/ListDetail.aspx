<%@ Page Title="" Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="ListDetail.aspx.cs" Inherits="Recruitment_ListDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 100%" cellpadding="20" cellspacing="0" border="0">
<tr>
...
<tr>
<td valign="top">
<table style="margin-left: 2px; margin-right: 2px; margin-top: 2px; width: 99%;" class="tableBorder">
<tr>
    <td class="tdTitleCenter" align="center">
        <asp:Label ID="Label48" runat="server" CssClass="labelTitleCenter" Text="NHẬP SAU ĐÓ IN MẪU ĐƠN, KÝ TÊN VÀ NỘP TẠI BAN TCNS"></asp:Label>
    </td>
</tr>
<tr>
    ...
    <td align="left" class="tdTable">
        <table cellpadding="0" cellspacing="0" border="0">
            <tr>
                ...
                <td style="width: 10px"></td>
                <td align="left">
                    <asp:Label ID="Label54" runat="server" CssClass="label" Text="Nơi Sinh"></asp:Label>
                    <br/>
                    <asp:TextBox ID="txtBirthPlace" runat="server" Width="200px" CssClass="textBox"></asp:TextBox>
                </td>
                <td style="width: 10px"></td>
                <td align="left">
                    <asp:Label ID="Label55" runat="server" CssClass="label" Text="Quốc tịch"></asp:Label>
                    <br/>
                    <asp:TextBox ID="txtNationality" runat="server" Width="100px" CssClass="textBox"></asp:TextBox>
                </td>
                <td style="width: 10px"></td>
                <td align="left">
                    <asp:Label ID="Label56" runat="server" CssClass="label" Text="Dân tộc"></asp:Label>
                    <br/>
...
<tr>
    <td align="left" class="tdTable">
        ...
        <table style="width: 100%" class="tableBorder" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <asp:DataList ID="dlEducation" runat="server" Width="100%" OnItemDataBound="dlEducation_ItemDataBound">
                        <HeaderTemplate>
                        ...
                        <ItemTemplate>
                            <table style="width: 100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="width: 5%;" align="center" valign="middle">
                                        <asp:ImageButton ID="imgDeleteRow" runat="server" ImageUrl="~/Images/icon-delete.gif" OnClick="imgDeleteRowdlTraining_Click"/>
                                    </td>
                                    <td style="width: 5%;" align="center" valign="middle">
                                        <asp:ImageButton ID="imgAddNewRow" runat="server" ImageUrl="~/Images/Add.gif" OnClick="imgAddNewRowdlTraining_Click" Visible="false"/>
                                    </td>
                                </tr>
                        ...
                        <ItemTemplate>
                            <table style="width: 100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="width: 5%;" align="center" valign="middle">
                                        <asp:ImageButton ID="imgDeleteRow" runat="server" ImageUrl="~/Images/icon-delete.gif" OnClick="imgDeleteRowdlTrainingIncomplete_Click"/>
                                    </td>
                                    <td style="width: 5%;" align="center" valign="middle">
                                        <asp:ImageButton ID="imgAddNewRow" runat="server" ImageUrl="~/Images/Add.gif" OnClick="imgAddNewRowdlTrainingIncomplete_Click" Visible="false"/>
                                    </td>
                                </tr>
...
<tr>
    <td align="left" class="tdTable">
        <asp:Label ID="Label7" runat="server" CssClass="labelTitle" Text="4. NGOẠI NGỮ / VI TÍNH"></asp:Label>
        <table style="width: 100%" class="tableBorder" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                        ...
                        <ItemTemplate>
                            <table style="width: 100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="width: 5%;" align="center" valign="middle">
                                        <asp:ImageButton ID="imgDeleteRow" runat="server" ImageUrl="~/Images/icon-delete.gif" OnClick="imgDeleteRowdlJob_Click"/>
                                    </td>
                                    <td style="width: 5%;" align="center" valign="middle">
                                        <asp:ImageButton ID="imgAddNewRow" runat="server" ImageUrl="~/Images/Add.gif" OnClick="imgAddNewRowdlJob_Click" Visible="false"/>
                                    </td>
                                </tr>
                            ...
                            <table style="width: 100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="width: 90%;" align="left" valign="top">
                                        <asp:TextBox ID="txtExperience" runat="server" CssClass="textBox" Width="95%"></asp:TextBox>
                                    </td>

                                    <td style="width: 5%;" align="center" valign="middle">
                                        <asp:ImageButton ID="imgDeleteRow" runat="server" ImageUrl="~/Images/icon-delete.gif" OnClick="imgDeleteRowdlExperience_Click"/>
                                    </td>
                                    <td style="width: 5%;" align="center" valign="middle">
                                        <asp:ImageButton ID="imgAddNewRow" runat="server" ImageUrl="~/Images/Add.gif" OnClick="imgAddNewRowdlExperience_Click" Visible="false"/>
                                    </td>
                                </tr>
                            </table>
                        </ItemTemplate>
                        ...
                        <ItemTemplate>
                            <table style="width: 100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="width: 5%;" align="center" valign="middle">
                                        <asp:ImageButton ID="imgDeleteRow" runat="server" ImageUrl="~/Images/icon-delete.gif" OnClick="imgDeleteRowdlExperienceOther_Click"/>
                                    </td>
                                    <td style="width: 5%;" align="center" valign="middle">
                                        <asp:ImageButton ID="imgAddNewRow" runat="server" ImageUrl="~/Images/Add.gif" OnClick="imgAddNewRowdlExperienceOther_Click" Visible="false"/>
                                    </td>
                                </tr>
                            </table>
                        </ItemTemplate>
                        ...
                        <ItemTemplate>
                            <table style="width: 100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="width: 5%;" align="center" valign="middle">
                                        <asp:ImageButton ID="imgAddNewRow" runat="server" ImageUrl="~/Images/Add.gif" OnClick="imgAddNewRowdlFatherMother_Click" Visible="false"/>
                                    </td>
                                </tr>
                        ...
                        <ItemTemplate>
                            <table style="width: 100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="width: 5%;" align="center" valign="middle">
                                        <asp:ImageButton ID="imgDeleteRow" runat="server" ImageUrl="~/Images/icon-delete.gif" OnClick="imgDeleteRowdlSAGSFamily_Click"/>
                                    </td>
                                    <td style="width: 5%;" align="center" valign="middle">
                                        <asp:ImageButton ID="imgAddNewRow" runat="server" ImageUrl="~/Images/Add.gif" OnClick="imgAddNewRowdlSAGSFamily_Click" Visible="false"/>
                                    </td>
                                </tr>
                        ...
                        <ItemTemplate>
                            <table style="width: 100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="width: 5%;" align="center" valign="middle">
                                        <asp:ImageButton ID="imgDeleteRow" runat="server" ImageUrl="~/Images/icon-delete.gif" OnClick="imgDeleteRowdlInforConfirm_Click"/>
                                    </td>
                                    <td style="width: 5%;" align="center" valign="middle">
                                        <asp:ImageButton ID="imgAddNewRow" runat="server" ImageUrl="~/Images/Add.gif" OnClick="imgAddNewRowdlInforConfirm_Click" Visible="false"/>
                                    </td>
                                </tr>
...
<tr>
    <td class="tdTitle">
        <asp:Label ID="Label50" runat="server" CssClass="labelTitle" Text="DUYỆT HỒ SƠ"></asp:Label>
    </td>
</tr>
<tr>
    <td align="left" class="tdTable">
        <table cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td align="left" valign="middle">
                    <asp:Label ID="Label52" runat="server" CssClass="label" Text="Số báo danh" Font-Bold="true"></asp:Label>
                    <br/>
                    <asp:TextBox ID="txtCandidateNumber" runat="server" Width="60px" CssClass="textBox"></asp:TextBox>
                </td>
                <td style="width: 10px"></td>
                <td align="left" valign="middle">
                    <asp:Label ID="Label53" runat="server" CssClass="label" Text="Hồ sơ" Font-Bold="true"></asp:Label>
                    <br/>
                    <asp:DropDownList ID="ddlCandidateStatus" runat="server" Width="100px" CssClass="dropDownList">
                    </asp:DropDownList>
                </td>
            </tr>
        </table>
...
<tr>
    <td align="left" class="tdTable">
        <asp:Label ID="Label51" runat="server" CssClass="label" Text="Ghi chú" Font-Bold="true"></asp:Label>
        <br/>
        <asp:TextBox ID="txtRemark" runat="server" Width="350px" CssClass="textBox"
                     TextMode="MultiLine" Rows="4">
        </asp:TextBox>
    </td>
</tr>
        ...
        <table style="width: 100%; margin-top: 0px;">
            <tr>
                <td align="center">
                    ...
                    <asp:Button ID="btnPrint" runat="server" Text="In Đơn Dự Tuyển" CssClass="small color green button" Width="150px" OnClick="btnPrint_Click" Visible="true"/>&nbsp;&nbsp;
                    ...
                    &nbsp;&nbsp;
                    <asp:Button ID="Button1" runat="server" Text="Blacklist" 
                                CssClass="small color green button" Width="100px" 
                                OnClick="Button1_Click" 
                        onclientclick="Bạn có muốn thêm người này vào danh sách blacklist?"/>

<%@ Page Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="ResultR1.aspx.cs" Inherits="Recruitment_ResultR1" Title="SAGS :: HUMAN RESOURCES MANAGEMENT" %>
            ...
            <tr>
                <td align="left">
                    <table class="tableBorder" width="100%" style="background-color:#d5d5d5" cellpadding="0" cellspacing="0">
                         <tr>
                            <td>                                
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="odsCandidateList" Width="100%" CellPadding="0" OnRowDataBound="GridView2_RowDataBound1" PageSize="20">
                                    <Columns>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                             ...
                                             <ItemTemplate>
                                                <tr class="grid-item">
                                                    ...
                                                    <td align="left" class="value">
                                                        <asp:Literal ID="ltExperience" runat="server"></asp:Literal></td>
                                                    <td align="center">
                                                    ...
                                                    <td align="center">
                                                    <asp:Label ID="lbResult" CssClass="value" runat="server"></asp:Label>
                                                       </td>
                                                       <td align="center">
                                                    <asp:Label ID="lbRemark1" CssClass="value" runat="server"></asp:Label>
                                                       </td>

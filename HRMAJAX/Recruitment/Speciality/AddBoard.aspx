<%@ Page Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="AddBoard.aspx.cs" Inherits="Recruitment_Repairing_AddPractice" Title="Untitled Page" %>
                                    ...
                                    <Columns>
                                       ...
                                       <asp:TemplateField HeaderText="Kết quả">
                                        ...
                                        <asp:TemplateField HeaderText="Ghi chú">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtRemark2" runat="server" CssClass="textBox" Width="200px"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" />
                                            <HeaderStyle HorizontalAlign="Center" />
                                        </asp:TemplateField>

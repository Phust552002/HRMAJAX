<%@ Page Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="Trainee.aspx.cs" Inherits="Recruitment_Trainee" Title="SAGS :: HUMAN RESOURCES MANAGEMENT" %>
                         ...
                         <tr>
                            <td>  
                                ...
                                <asp:ObjectDataSource ID="odsCandidateForTraining" runat="server"
                                    ...
                                    OnSelecting="odsCandidateForTraining_Selecting" 
                                    OnSelected="odsCandidateForTraining_Selected">
                                    <SelectParameters>
   ...
   <tr>
        <td align="center">
            <asp:Button ID="Button1" runat="server" CssClass="small color green button" OnClick="Button1_Click"
                Text="Chuyển thành học viên chính thức" /></td>
    </tr>
</table>    
</asp:Content>

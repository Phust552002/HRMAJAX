<%@ Page Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="CntType.aspx.cs" Inherits="Contracts_CntType" Title="SAGS :: HUMAN RESOURCES MANAGEMENT" %>
                                ...
                                <tr>
                                    <td>
                                         <asp:GridView ID="grdContracts" runat="server" AutoGenerateColumns="False" DataSourceID="odsContractTypes" AllowPaging="True" PageSize="20" DataKeyNames="ContractTypeId" Width="100%" OnRowCancelingEdit="grdContracts_RowCancelingEdit" OnRowUpdated="grdContracts_RowUpdated" OnRowDeleted="grdContracts_RowDeleted" CssClass="grid-Border">
                                            <Columns>
                                                <asp:TemplateField HeaderText="M&#227; loại" SortExpression="ContractTypeCode">
                                                    <EditItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="T&#234;n loại hợp đồng" SortExpression="ContractTypeName">
                                                    <EditItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Thời gian (số th&#225;ng)" SortExpression="ContractTypeValue">
                                                    <EditItemTemplate>
                    ...
                    <tr>
                        <td>
                            <table class="tableBorder" style="width: 100%;" >
                                ...
                                <tr>
                                    <td class="tdLabel">
                                        <asp:Label ID="Label5" runat="server" CssClass="label" Text="Thời gian (số tháng)"></asp:Label></td>
                                    <td class="tdValue">

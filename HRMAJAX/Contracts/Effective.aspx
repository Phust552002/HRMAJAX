<%@ Page Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="Effective.aspx.cs" Inherits="Contracts_Effective" Title="SAGS :: HUMAN RESOURCES MANAGEMENT" %>
                                        ...
                                        <asp:GridView ID="grdContractEmployee" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="Họ v&#224; t&#234;n" SortExpression="FullName">
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkFullName" runat="server" CssClass="hyperlink-Grid" Text='<%# Eval("FullName") %>'></asp:HyperLink>
                                                    </ItemTemplate>

<%@ Page Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="DetailContractEmployee.aspx.cs" Inherits="Contracts_DetailContractEmployee" Title="SAGS :: HUMAN RESOURCES MANAGEMENT" %>
...
<%@ Register Src="UserControls/History.ascx" TagName="History" TagPrefix="uc5" %>
<%@ Register Src="UserControls/Add.ascx" TagName="Add" TagPrefix="uc6" %>
            ...
            <tr>
                <td>
                     <table width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td>
                                <table width="100%" class="borderMultiView" cellpadding="0" cellspacing="2">
                                    <tr>
                                        <td>                                        

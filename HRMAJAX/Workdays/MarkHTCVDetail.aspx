<%@ Page Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="MarkHTCVDetail.aspx.cs" Inherits="Workdays_MarkHTCVDetail" Title="SAGS :: HUMAN RESOURCES MANAGEMENT" %>
...
<table style="width: 100%">
            ...
            <tr>
                <td>
                   <table style="width: 100%" class="tableBorder">
                        ...
                        <tr>
                            <td class="tdLabel">
                                <asp:Label ID="Label8" runat="server" Text="Tổng hợp ghi chú" CssClass="label"></asp:Label></td>
                            <td class="tdValue" colspan="3" >
                                <asp:TextBox ID="txtSummaryRemark" runat="server" CssClass="textBox" 
            ...
            <tr>
                <td>
                        ...
                        <table style="width: 100%" class="tableBorder">
                            <tr>
                                <td style="background-color:#f3f4f9;" align="left">
                                    <asp:Label id="Label3" runat="server" CssClass="label" Text="Lưu ý: (A1: 101->115); (A: 91->100); (B: 76->90); (C: 66->75); (D: 0->66)"></asp:Label>
                                </td>
                                <td style="background-color:#f3f4f9;" align="right"> 
                                    <asp:CheckBox ID="chkHide" runat="server" Text="Nhập Điểm Đánh Giá HTCV" CssClass="value" OnCheckedChanged="chkHide_CheckedChanged" AutoPostBack="True"/><br/>
                                           
                                </td>
                            </tr> 
                            <tr>
                                <td style="background-color:#f3f4f9;" colspan="2">

<%@ Page Language="C#" EnableEventValidation="false" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="Add.aspx.cs" Inherits="Workdays_Add" Title="SAGS :: HUMAN RESOURCES MANAGEMENT" %>
...
<FIELDSET class="fieldset"><LEGEND class="legend"><asp:Label id="lbTitlefirst" runat="server" Text=""></asp:Label>&nbsp;<asp:Label id="lbTitleList" runat="server" Text="Chưa chọn phòng"></asp:Label></LEGEND><TABLE style="WIDTH: 100%" class="tableBorder"><TBODY><TR class="tdLabel">
    <TD align=right><TABLE cellSpacing=0 cellPadding=0 width="100%"><TBODY><TR><TD style="WIDTH: 10%" align=left><TABLE width="100%"><TBODY><TR><TD style="WIDTH: 25%" align=right><asp:ImageButton id="btnSend" onclick="btnSend_Click" runat="server" ImageUrl="~/Images/Icon_Send.gif" Visible="False"></asp:ImageButton></TD><TD style="WIDTH: 25%" align=left><asp:LinkButton id="lnkSend" onclick="btnSend_Click" runat="server" CssClass="hyperlink-Button" Visible="False">Gửi</asp:LinkButton></TD><TD style="WIDTH: 25%" align=left><asp:ImageButton id="imgDelete" onclick="imgDelete_Click" runat="server" ImageUrl="~/Images/icon-delete.gif" Visible="False" OnClientClick="return confirm('Bạn có chắc muốn xóa bảng chấm công này ?');" __designer:wfdid="w1"></asp:ImageButton></TD><TD style="WIDTH: 25%" align=left><asp:LinkButton id="lnkDelete" onclick="lnkDelete_Click" runat="server" CssClass="hyperlink-Button" Visible="False" OnClientClick="return confirm('Bạn có chắc muốn xóa bảng chấm công này ?');" __designer:wfdid="w2">Xóa</asp:LinkButton></TD><TD style="WIDTH: 25%" align=left><asp:DropDownList id="ddlViewType" runat="server" CssClass="dropDownList" __designer:wfdid="w3" AutoPostBack="True" OnSelectedIndexChanged="ddlViewType_SelectedIndexChanged"><asp:ListItem Value="1">Xem mặc định</asp:ListItem>
...
</asp:DropDownList> &nbsp;&nbsp;<asp:Label id="Label12" runat="server" CssClass="label" Text="Năm"></asp:Label> <asp:DropDownList id="ddlYears" runat="server" CssClass="dropDownList" AutoPostBack="True" OnSelectedIndexChanged="ddlYears_SelectedIndexChanged"></asp:DropDownList> </TD><TD style="WIDTH: 10%" align=right><asp:Button id="imgSearch" onclick="imgSearch_Click" runat="server" Text="Xem" CssClass="small color green button"></asp:Button> </TD></TR></TBODY></TABLE></TD></TR><TR class="tdLabel">
    <TD align=center><asp:GridView id="grdWorkdayEmployees" runat="server" Width="100%" CssClass="grid-Border" OnSelectedIndexChanged="grdWorkdayEmployees_SelectedIndexChanged" DataSourceID="ObjectDataSource1" PageSize="5" OnRowDataBound="grdWorkdayEmployees_RowDataBound" DataKeyNames="UserId" AutoGenerateColumns="False" AllowPaging="True">
...
<ItemTemplate>
<asp:LinkButton id="lnkFullName" runat="server" CssClass="hyperlink-Grid" Text='<%# Bind("FullName") %>' __designer:wfdid="w5" CommandName="Select" ToolTip='<%# Bind("UserId") %>'></asp:LinkButton> 
</ItemTemplate>
</asp:TemplateField>
<asp:TemplateField SortExpression="XQD" HeaderText="Xqđ">
<ItemStyle Width="30px" HorizontalAlign="Center"></ItemStyle>
<ItemTemplate>
<asp:Label id="lbXQD" runat="server" __designer:wfdid="w6"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
<ItemTemplate>
<asp:Label id="lbNC_LamViec" runat="server" __designer:wfdid="w7"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
<ItemTemplate>
<asp:HyperLink id="lnkF_Nam_Fdb_DD" runat="server" __designer:wfdid="w4"></asp:HyperLink> 
</ItemTemplate>
</asp:TemplateField>
...
<asp:Parameter Type="Int32" Name="typeSort"></asp:Parameter>
                                                        ...
                                                        <tr>
                                                            <td colspan="2" class="tdButton" align="center"> 
                                                                <table width="100%">
                                                                    <tr>
                                                                        <td style="width:50%" align="right"><asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" Text="Lưu" CssClass="small color green button"/></td>

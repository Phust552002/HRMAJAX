<%@ Page Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="AddSynchrony.aspx.cs" Inherits="Workdays_AddSynchrony" Title="Untitled Page" %>
                ...
                <tr>
                    <td valign="top">                         
                        <table style="width: 100%" class="tableBorder"> 
                            <tr>
                                <td style="width:20%; background-image: none;" valign="top" class="tdTreeView" align="left">
                                    <asp:TreeView  
                                        ID="TreeView1"
                                        ExpandDepth="2" 
                                ...
                                <td style="width:80%" valign="top">
                                    ...
                                    <ContentTemplate>
<FIELDSET class="fieldset"><LEGEND class="legend"><asp:Label id="lbTitlefirst" runat="server" Text=""></asp:Label>&nbsp;<asp:Label id="lbTitleList" runat="server" Text="Chưa chọn phòng"></asp:Label></LEGEND><TABLE style="WIDTH: 100%" class="tableBorder"><TBODY><TR class="tdLabel"><TD align=right colSpan=2><TABLE cellSpacing=0 cellPadding=0 width="100%"><TBODY><TR><TD style="WIDTH: 10%" align=left><TABLE width="100%"><TBODY><TR><TD style="WIDTH: 25%" align=right><asp:ImageButton id="btnSend" onclick="btnSend_Click" runat="server" ImageUrl="~/Images/Icon_Send.gif" Visible="False"></asp:ImageButton></TD><TD style="WIDTH: 25%" align=left><asp:LinkButton id="lnkSend" onclick="btnSend_Click" runat="server" CssClass="hyperlink-Button" Visible="False">Gửi</asp:LinkButton></TD><TD style="WIDTH: 25%" align=left><asp:ImageButton id="imgDelete" onclick="imgDelete_Click" runat="server" ImageUrl="~/Images/icon-delete.gif" Visible="False" OnClientClick="return confirm('Bạn có chắc muốn xóa bảng chấm công này ?');"></asp:ImageButton></TD><TD style="WIDTH: 25%" align=left><asp:LinkButton id="lnkDelete" onclick="lnkDelete_Click" runat="server" CssClass="hyperlink-Button" Visible="False" OnClientClick="return confirm('Bạn có chắc muốn xóa bảng chấm công này ?');">Xóa</asp:LinkButton></TD><TD style="WIDTH: 25%" align=left><asp:DropDownList id="ddlViewType" runat="server" CssClass="dropDownList" AutoPostBack="True" OnSelectedIndexChanged="ddlViewType_SelectedIndexChanged"><asp:ListItem Value="1">Xem mặc định</asp:ListItem>
...
<tr>
    <td colspan="2" align="center">
        ...
        <table width="100%" class="tableBorder">
            <tr>
                <td class="tdLabel"><asp:Label ID="lbFromDate" runat="server" CssClass="label" Text="Từ ngày"></asp:Label></td>
                <td class="tdValue"><uc2:CalendarPicker id="cpFromDate" runat="server"></uc2:CalendarPicker></td>
                <td class="tdLabel" align="left"><asp:Label ID="lbToDate" runat="server" CssClass="label" Text="Đến ngày"></asp:Label></td>
                <td class="tdValue" align="left"><uc2:CalendarPicker id="cpToDate" runat="server"></uc2:CalendarPicker></td>                
            </tr>
            <tr>
                <td colspan="4" class="tdButton" align="center">                                                                                                                                                                                   
                    <asp:Button ID="btnSynchrony" runat="server" CssClass="small color green button" Text="Đồng bộ" OnClick="btnSynchrony_Click" /></td>
            </tr>
        </table>
    </td>
</tr>       
<asp:Panel id="pnTimeKeeping" runat="server" Width="100%" Visible="false">
                                                            ...
                                                            <td align="left" colspan="2">                                                                                                                                                                             
                                                               <table style="width: 100%; background-color:White" class="tableBorder" >
                                                                    <tr class="grid-header1">
                                                                        <td colspan="7" align="center"><asp:Label ID="lbEmployeeSelected" runat="server"></asp:Label></td>
                                                                    </tr>
                                                                    <tr class="grid-header1">
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" class="tdLabel">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight12" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdLabel">
                                                                             <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight13" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdLabel">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight14" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>   
                                                                        </td>
                                                                        <td align="center" class="tdLabel">
                                                                             <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight15" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>                  
                                                                         </td>
                                                                        <td align="center" class="tdLabel">
                                                                             <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight16" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>                        
                                                                         </td>
                                                                        <td align="center" class="tdValue">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight17" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>                   
                                                                         </td>
                                                                        <td align="center" class="tdValue">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight18" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="center" class="tdLabel">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight22" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdLabel">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight23" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdLabel">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight24" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdLabel">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight25" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdLabel">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight26" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdValue">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight27" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdValue">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight28" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                       </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="center" class="tdLabel">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight32" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdLabel">
                                                                             <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight33" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                       </td>
                                                                        <td align="center" class="tdLabel">
                                                                             <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight34" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdLabel">
                                                                             <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight35" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdLabel">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight36" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdValue">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight37" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                       </td>
                                                                        <td align="center" class="tdValue">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight38" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="center" class="tdLabel">
                                                                             <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight42" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdLabel">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight43" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdLabel">
                                                                             <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight44" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdLabel">
                                                                             <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight45" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdLabel">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight46" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdValue">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight47" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>                                                                                
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdValue">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight48" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="center" class="tdLabel">
                                                                             <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight52" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                       </td>
                                                                        <td align="center" class="tdLabel">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight53" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdLabel">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight54" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdLabel">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight55" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdLabel">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight56" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdValue">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight57" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdValue">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight58" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="center" class="tdLabel">
                                                                             <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight62" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                       </td>
                                                                        <td align="center" class="tdLabel">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight63" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdLabel">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight64" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdLabel">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight65" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdLabel">
                                                                             <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight66" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                        <td align="center" class="tdValue">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight67" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                         </td>
                                                                        <td align="center" class="tdValue">
                                                                            <table cellpadding="0" cellspacing="0" style="width:100%"> 
                                                                                ...
                                                                                <tr><td align="right"><asp:Label ID="lbNight68" runat="server" CssClass="value-Calendar"></asp:Label></td></tr>
                                                                            </table>
                                                                        </td>
                                                                    </tr>
                                                                </table>                                                        

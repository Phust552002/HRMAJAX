<%@ Page Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="DepartmentEmployeeList.aspx.cs" Inherits="Department_DepartmentEmployeeList" Title="SAGS :: HUMAN RESOURCES MANAGEMENT" %>
                                    ...
                                    <fieldset class="fieldset">
                                        ...
                                        <table style="width: 100%">
                                            <tr>
                                                ...
                                                <td style="width:10%"><asp:Button id="imgSearch" onclick="imgSearch_Click" runat="server" Text="Xem" CssClass="small color green button"></asp:Button></td>
                                            </tr>
                                        </table>
                                        <table style="width: 100%" class="tableBorder">
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" Width="100%" CssClass="grid-Border" AllowPaging="True" PageSize="20">
                                                        <Columns>
                                                            <asp:BoundField DataField="UserId" HeaderText="M&#227; nh&#226;n vi&#234;n" SortExpression="UserId" HtmlEncode="False" DataFormatString="{0:000#}">
                                                                <ItemStyle HorizontalAlign="Center" />
                                                                <HeaderStyle HorizontalAlign="Center" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="EmployeeCode" HeaderText="M&#227; SAA"
                                                            ...
                                                            <asp:BoundField DataField="DepartmentFullName" HeaderText="Ph&#242;ng ban" SortExpression="DepartmentFullName" >
                                                                <ItemStyle HorizontalAlign="Left" />
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="Birthday" HeaderText="Ng&#224;y sinh" SortExpression="Birthday" HtmlEncode="False" DataFormatString="{0:dd/MM/yyyy}" >
                                                                <ItemStyle HorizontalAlign="Center" />
                                                                <HeaderStyle HorizontalAlign="Center" />
                                                            </asp:BoundField>
                                                        </Columns>
                                                    ...
                                                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OnSelecting="ObjectDataSource1_Selecting"
                                                        SelectMethod="GetByDeptIds" TypeName="HRMBLL.H0.EmployeesBLL" OldValuesParameterFormatString="original_{0}" OnSelected="ObjectDataSource1_Selected" SortParameterName="sortParameter">
                                                        <SelectParameters>

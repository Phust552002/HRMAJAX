...
<%@ Register Src="~/Employee/UserControls/Personal//DetailInfor.ascx" TagName="DetailInfor" TagPrefix="uc3" %>
<%@ Register Src="~/Employee/UserControls/Personal/GeneralInfo.ascx" TagName="GeneralInfo" TagPrefix="uc2" %>

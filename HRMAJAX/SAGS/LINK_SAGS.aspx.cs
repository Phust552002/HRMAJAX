...
public partial class SAGS_LINK_SAGS : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            Response.Redirect("http://10.10.55.5/hrm/Login.aspx?n=" + ucPermission1.UserCurrent.UserName + "&m=" + ucPermission1.UserCurrent.Password);

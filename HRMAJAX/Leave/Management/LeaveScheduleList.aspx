<%@ Page Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="LeaveScheduleList.aspx.cs" Inherits="Management_Leave_LeaveScheduleList" Title="SAGS :: HUMAN RESOURCES MANAGEMENT" %>
                                ...
                                <PagerStyle CssClass="grid-paper"></PagerStyle>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Tổng ngày phép" ItemStyle-Width="95px" ItemStyle-Wrap="true" >
                                            ...
                                            <ItemStyle Font-Bold="True" HorizontalAlign="Right" Width="65px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Còn lại" ItemStyle-Width="95px" ItemStyle-Wrap="true" >
                                            ...
                                            <ItemStyle Font-Bold="True" HorizontalAlign="Right" Width="45px" />
                                        </asp:TemplateField>

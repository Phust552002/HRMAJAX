<%@ Page Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="LeaveScheduleDetail.aspx.cs" Inherits="Leave_LeaveScheduleDetail" Title="SAGS :: HUMAN RESOURCES MANAGEMENT" %>
    ...
    <table style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td class="tdValue">
                                <asp:TextBox ID="txtNghiNgoaiKeHoach" runat="server" CssClass="value" 
                                    Width="345px" BorderColor="Red">0</asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="tdLabel" style="width: 190px">
        ...
        <tr>
            <td align="center">
                ...
                <asp:Button ID="lnkSave" runat="server" OnClick="btnSave_Click" Text="Lưu" 
                    CssClass="small color green button" Width="100px" />
                                                &nbsp;&nbsp;&nbsp;
                <asp:Button ID="LinkButton1" runat="server" Text="Gửi" 

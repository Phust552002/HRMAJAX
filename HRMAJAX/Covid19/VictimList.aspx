<%@ Page Language="C#" MasterPageFile="~/HRM.master" AutoEventWireup="true" CodeFile="VictimList.aspx.cs" Inherits="Covid19_VictimList" Title="SAGS :: HUMAN RESOURCES MANAGEMENT" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"> 
    ...
    <tr>
        <td>                   
           <iframe id="pbi" runat="server" width="100%" height="768" src="https://app.powerbi.com/view?r=eyJrIjoiNTVhYjU1YjMtMTM1NC00MGZlLTk0MTYtMjFkNDg1MWZkYWZhIiwidCI6ImY3OTY3M2Q3LThlOTUtNGM3My04YWJiLTU0OGUzMWFhM2M1YSIsImMiOjEwfQ%3D%3D&pageName=ReportSection" frameborder="0" allowFullScreen="true"></iframe>                    
        </td>
    </tr>
</table>
                                                ...
                                                &nbsp;
                                                 ...
                                                 &nbsp;    
                                                    ...
                                                    <asp:DropDownList ID="ddlType" runat="server" CssClass="dropDownList" AppendDataBoundItems="true">
                                                        ...
                                                        <asp:ListItem Text="F0" Value="F0"></asp:ListItem>
                                                        <asp:ListItem Text="F1" Value="F1"></asp:ListItem>
                                                    </asp:DropDownList>
...
<asp:ObjectDataSource id="odsEmployees" runat="server" OnSelecting="odsEmployees_Selecting" TypeName="HRMBLL.H8.Covid19BLL" SelectMethod="GetByDeptIds" OldValuesParameterFormatString="original_{0}" OnSelected="odsEmployees_Selected"><SelectParameters>

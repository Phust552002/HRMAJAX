<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DecisionFilter.ascx.cs" Inherits="Decisions_UserControls_DecisionFilter" %>
                ...
                <tr>
                    <td align="center">
                        <table cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label2" runat="server" Text="Loại HĐ" CssClass="label"></asp:Label><br />
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label4" runat="server" CssClass="label" Text="Tháng/năm"></asp:Label>&nbsp;<asp:DropDownList
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label3" runat="server" Text="Xem tất cả" CssClass="label"></asp:Label>
